...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.bmView'/]"></script>
...
<body>
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<div class="form-horizontal">
									<div class="form-group" id="">
								    	<label for=""  class="col-xs-8 col-sm-2 col-md-2 col-lg-2  control-label">BM类型</label>
									...
									<div class="form-group" id="">
								    	<label for=""  class="col-xs-8 col-sm-2 col-md-2 col-lg-2  control-label">BM编码</label>
								    	<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 my-text-right">
								    		<p class="text-muted p-line-height bm-code-text" id="">${data.baseBm.bmCode!}</p>
								   		 </div>
							    	</div><!-- form-group -->
									<div class="form-group" id="">
								    	<label for=""  class="col-xs-8 col-sm-2 col-md-2 col-lg-2  control-label">销售开始日</label>
								    	<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 my-text-right">
								    		<p class="text-muted p-line-height bm-code-text" id="startDate">${data.baseBm.bmEffFrom?c}</p>
								   		 </div>
								    	<label for=""  class="col-xs-8 col-sm-2 col-md-2 col-lg-2  control-label">销售结束日</label>
								    	<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 my-text-right">
								    		<p class="text-muted p-line-height bm-code-text" id="endDate">${data.baseBm.bmEffTo?c}</p>
								   		 </div>
							    	</div><!-- form-group -->
							    	<div class="form-group" id="bm_promotion_box">
									    <label for=""  class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label">
									    	促销店铺
									   	</label>
		...
		<div class="row detail-box" style="margin-top:10px;" id="detail_box">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center  vice-but-box">
				[@permission code="P-BM-012"]
					[#if displayVar==1]
						<button id="affirm2" type="button" class="btn  btn-warning but-hide affirm" ><span class="glyphicon glyphicon-check"></span> 确认</button>
						<button id="reject_aff2" type="button" class="btn  btn-danger but-hide reject_aff"><span class="glyphicon glyphicon-share"></span> 驳 回</button>
					[/#if]
				[/@permission]
				[@permission code="P-BM-021"]
					[#if displayVar==1]
						<button id="check2" type="button" class="btn  btn-primary but-hide check"><span class="glyphicon glyphicon-edit"></span> 审 核</button>
						<button id="reject2" type="button" class="btn  btn-danger but-hide reject"><span class="glyphicon glyphicon-share"></span> 驳 回</button>
					[/#if]
				[/@permission]
				[@permission code="P-BM-032"]
					...
					[/#if]
				[/@permission]
				[@permission code="P-BM-014"]
					[#if displayVar==1]
						<button id="del2" type="button" class="btn  btn-danger del" ><span class="glyphicon glyphicon-trash"></span> 删 除</button>
					[/#if]
				[/@permission]
				[@permission code="P-BM-033"]
					[#if displayVar==1]
						<button id="del2" type="button" class="btn  btn-danger del" ><span class="glyphicon glyphicon-trash"></span> 删 除</button>
					[/#if]
				[/@permission]
				<button id="returnsViewBut2" type="button" class="btn btn-default returnsViewBut"><span class="glyphicon glyphicon-share icon-right"></span>Back</button>
			</div>
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
				<div class="box">
				 	<div class="box-title ">
						...
						<div class="row">
							[#if data.baseBm.bmType=="01" || data.baseBm.bmType=="02" || data.baseBm.bmType=="03"]
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<div class="form-horizontal">
										<div class="form-group" id="">
										    <label for="item_name"  class="col-xs-8 col-sm-2 col-md-2 col-lg-2 control-label">BM数量</label>
										    <div class="col-xs-4 col-sm-10 col-md-10 col-lg-2 my-text-right">
										    	<span id=""  class="text-muted p-line-height bm-code-text">${data.bmCount!}</span>
										    </div>
										    <label for="item_name"  class="col-xs-8 col-sm-2 col-md-2 col-lg-2 control-label">BM折扣</label>
										    <div class="col-xs-4 col-sm-10 col-md-10 col-lg-2 my-text-right">
										    	<span id=""  class="text-muted p-line-height bm-code-text">${data.bmDiscount!}</span>
										    </div>
										    <label for="item_name"  class="col-xs-8 col-sm-2 col-md-2 col-lg-2 control-label">BM商品价格</label>
										    <div class="col-xs-4 col-sm-10 col-md-10 col-lg-2 my-text-right">
							...
							[#elseif data.baseBm.bmType=="04"]
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<div class="form-horizontal">
										<div class="form-group" id="">
										    <label for="item_name"  class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label">Item Barcode</label>
										    <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10">
										...
										<div class="form-group" id="">
										    <label for="item_name"  class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label">购买数量</label>
										    <div class="col-xs-12 col-sm-10 col-md-10 col-lg-2">
										    	<span id=""  class="text-muted p-line-height bm-code-text">${data.buyCount!}</span>
										    </div>
										    <label for="item_name"  class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label">折扣</label>
										    <div class="col-xs-12 col-sm-10 col-md-10 col-lg-2">
										    	<span id=""  class="text-muted p-line-height bm-code-text">${data.bmDiscount!}</span>
										    </div>
									    </div><!-- form-group -->
							...
							[#elseif data.baseBm.bmType=="05"]
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<div class="form-horizontal">
										<div class="form-group" id="">
										    <label for="item_name"  class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label"></label>
											 <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	...
	<div class="container-fluid" id="">
		<div class="row" id="">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center box-body-padding-10">
				[@permission code="P-BM-012"]
					[#if displayVar==1]
						<button id="affirm" type="button" class="btn  btn-warning but-hide affirm" ><span class="glyphicon glyphicon-check"></span> 确认</button>
						<button id="reject_aff" type="button" class="btn  btn-danger but-hide reject_aff"><span class="glyphicon glyphicon-share"></span> 驳 回</button>
				...
				[@permission code="P-BM-021"]
					[#if displayVar==1]
						<button id="check" type="button" class="btn  btn-primary but-hide check"><span class="glyphicon glyphicon-edit"></span> 审 核</button>
						<button id="reject" type="button" class="btn  btn-danger but-hide reject"><span class="glyphicon glyphicon-share"></span> 驳 回</button>
				...
				[@permission code="P-BM-014"]
					[#if displayVar==1]
						<button id="del" type="button" class="btn  btn-danger del"  ><span class="glyphicon glyphicon-trash"></span> 删 除</button>
					[/#if]
				[/@permission]
				[@permission code="P-BM-033"]
					[#if displayVar==1]
	...
	<input type="hidden" id="bmStatus" value="${status!}" />
	<input type="hidden" id="checkFlg" value="${data.baseBm.checkFlg!}" />
	<input type="hidden" id="canReview" value="${data.canReview!}" />
	<input type="hidden" id="allItemAndDpt" value="${data.allItemAndDpt!}" />
	<input type="hidden" id="checkResources" value="${data.checkResources!}" />
	<input type="hidden" id="myCheckResources" value="${myCheckResources!}" />
	<input type="hidden" id="checkAudited" value="" />
