...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.groupSale'/]"></script>
...
[#--   </div>--]
	<!--导航-->
[#--	[@common.nav "HOME&Sale&Group Sale Item Sales Report"][/@common.nav]--]
	[@common.nav "HOME&Report&Group Sale Item Sales Report"][/@common.nav]
	<div class="container-fluid" id="main_box">
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<div class="form-horizontal">
									<div class="form-group">
                                        ...
                                        <label for=""  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Sales Date</label>
                                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-2">
        ...
        <!--row 分割-->
        <div class="row">
            <div id="table_div" class="col-xs-12 col-sm-12 col-md-6 col-lg-12 table-box">
                <div class="title">Group Sale Item Sales Report</div>
                <table border=0 cellSpacing=0 cellPadding=0 id="grid_table" class="gridTable" freezeColumnNum="0" freezeRowNum="1"></table>
            </div>
        </div>
    </div>
	<!--页脚-->
    ...
    [@permission code="SC-RF-GROUP-002"]<input type="hidden" class="permission-verify" id="printBut" value="${displayVar!}" />[/@permission]
</body>
</html>
