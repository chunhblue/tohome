...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.ordersupperview'/]"></script>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <label for="order_date"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Delivery Date</label>
                                    <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
                                        <input type="text" id="order_date" class="form-control input-sm" value="${data.deliveryDate!}" disabled>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="vendor_id"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Vendor Code</label>
                                    <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
                                        <input type="text" id="vendor_id" class="form-control input-sm" value="${data.vendorId!}"disabled>
                                    </div>
                                    <label for="vendor_name"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Vendor Name</label>
                                    <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
                                        <input type="text" id="vendor_name" class="form-control input-sm"  value="${data.vendorName!}" disabled>
                                    </div>
...
[#--                        </div>--]
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="wire"></div>
                            <button id="search"  hidden type="button" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-search icon-right"></span>Inquire</button>
                            <button id='reset'  hidden type='button' class='btn btn-primary btn-sm'><span class='glyphicon glyphicon-refresh icon-right'></span>Reset</button>
                        </div>
                    </div>
                </div>
            </div><!--box end-->
...
<input hidden  id="vendorName" value="${data.vendorName!}"/>
