...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.custPlanEntry'/]"></script>
...
[@permission code="SC-COST-ENTRY-004"]<input type="hidden" class="permission-verify" id="exportBut" value="${displayVar!}" />[/@permission]
[@permission code="SC-COST-ENTRY-005"]<input type="hidden" class="permission-verify" id="importBut" value="${displayVar!}" />[/@permission]
[@permission code="SC-COST-ENTRY-006"]<input type="hidden" class="permission-verify" id="printBut" value="${displayVar!}" />[/@permission]
[@permission code="SC-COST-ENTRY-008"]<input type="hidden" class="permission-verify" id="approvalBut" value="${displayVar!}" />[/@permission]
</body>
</html>
