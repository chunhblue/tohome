...
<head>
	...
	<script src="${m.staticpath}/[@spring.message 'js.custDataEnty'/]"></script>
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="col-xs-4 col-sm-2 col-md-2 col-lg-2">
								<input type="text" id="searchItemBcd" placeholder="Item Barcode" class="form-control input-sm">
							</div>
							<div class="col-xs-4 col-sm-2 col-md-2 col-lg-2">
							...
							<button id="restItemBtn" type="button" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-refresh icon-right"></span>Reset</button>
						</div>
					</div>
				</div>
			</div><!--box end-->
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-horizontal">
					...
					<div class="form-group">
						<label for="qty" class="col-sm-2 col-lg-5 control-label not-null">Qty</label>
						<div class="col-sm-6">
							<div class="aotu-pos">
