...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.cardPaymentReport'/]"></script>
...
<body>
[@common.nav "HOME&Report&Card Payment Report For HCM"][/@common.nav]
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-horizontal">
                              ...
                              <div class="form-group">
                                    ...
                                    <label for=""  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">To Date</label>
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 [#--col-lg-offset-1--] businessDaily_box">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: center">
                <span style="font-size: 25px;font-weight: bold">Card Payment Report For HCM</span>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <table id="dailyTable" class="table table-hover table-striped table-condensed table-bordered zgrid-table"
                    ...
                    <tr>
                        ...
                        <th title="Business Date">Business Date</th>
                        <th title="Trans Date">Trans Date</th>
                        <th title="Trans No">Trans No</th>
                        <th title="Approve Code">Approve Code</th>
                        <th title="Card Number">Card Number</th>
                        <th title="Receipt No">Receipt No</th>
                        <th title="Receipt No">Transaction  Number</th>
                        <th title="Description">Description</th>
                        <th title="Amount Ck">Amount Ck</th>
                        <th title="Amount VCB">Amount VCB</th>
                        <th title="Deposit Amount">Deposit Amount</th>
                        <th title="Free Amount">Free Amount</th>
                        <th title="Free Precent">Free Precent</th>
                        <th title="VAT">VAT</th>
