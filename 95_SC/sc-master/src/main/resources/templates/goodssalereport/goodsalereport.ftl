...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.goodsSaleReport'/]"></script>
...
[#--	</div>--]
<!--导航-->
[@common.nav "HOME&Report&Item Sales Daily Report"][/@common.nav]
<div class="container-fluid" id="main_box">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 [#--col-lg-offset-1--] businessDaily_box">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: center">
                    <span style="font-size: 25px;font-weight: bold">Item Sales Daily Report</span>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    ...
    <input type="hidden" id="totalItemSKU" value=""/>
    <input type="hidden" id="totalSaleAmount" value=""/>
