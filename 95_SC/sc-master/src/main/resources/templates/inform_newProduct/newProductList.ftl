...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.newProductList'/]"></script>
...
[#--   </div>--]
	<!--导航-->
	[@common.nav "HOME&Message&New Item Notifications"][/@common.nav]
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<div class="form-horizontal">
									...
									<div class="form-group">
										<label for="launching_time"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Launching Time</label>
										<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
											<input id="launching_time" placeholder="Launching Time" class="form-control input-sm select-date" type="text" value="">
										</div>
										<label for="start_order_date"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label" style="white-space: nowrap">Start Order Date</label>
										<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
											<input id="start_order_date" placeholder="Start Order Date" class="form-control input-sm select-date" type="text" value="">
										</div>
										<label for="product_type"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Product Type</label>
										<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
											<div class="aotu-pos">
												<input type="text" class="form-control input-sm" id="product_type" placeholder="" >
											</div>
										</div>
										<label for="informType" class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label" style="white-space: nowrap">Informaition Status</label>
										<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
