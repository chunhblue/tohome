...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.mmPromotionSaleDaily'/]"></script>
...
[#--	</div>--]
<!--导航-->
[@common.nav "HOME&Report&MM Promotion Sales Daily Report"][/@common.nav]
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label for="dep" class="col-sm-1 control-label">Promotion Pattern</label>
                                    <div class="col-sm-2">
                                        <div class="aotu-pos">
                                            <input type="text" class="form-control my-automatic input-sm" id="promotionPattern">
                                            <a id="patternRefresh" href="javascript:void(0);" title="Refresh"
                                               class="auto-but glyphicon glyphicon-refresh refresh"></a>
                                            <a id="patternRemove" href="javascript:void(0);" title="Clear"
                                               class="auto-but glyphicon glyphicon-remove circle"></a>
                                        </div>
                                    </div>
                                    <label for="pma" class="col-sm-1 control-label">Promotion Type</label>
                                    <div class="col-sm-2">
                                        <div class="aotu-pos">
                                            <input type="text" class="form-control my-automatic input-sm" id="promotionType">
                                            <a id="typeRefresh" href="javascript:void(0);" title="Refresh"
                                               class="auto-but glyphicon glyphicon-refresh refresh"></a>
                                            <a id="typeRemove" href="javascript:void(0);"
                                               title="Clear"
                                               class="auto-but glyphicon glyphicon-remove circle"></a>
                                        </div>
                                    </div>
                                    <label for="category" class="col-sm-1 control-label">Distribution Type</label>
                                    <div class="col-sm-2">
                                        <div class="aotu-pos">
                                            <input type="text" class="form-control my-automatic input-sm" id="distributionType">
                                            <a id="distributionTypeRefresh" href="javascript:void(0);" title="Refresh"
                                               class="auto-but glyphicon glyphicon-refresh refresh"></a>
                                            <a id="distributionTypeRemove" href="javascript:void(0);" title="Clear"
                                               class="auto-but glyphicon glyphicon-remove circle"></a>
                                        </div>
                                    </div>
                                    <label class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Promotion No.</label>
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                        <input type="text" id="promotionCd" class="form-control input-sm">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Item Barcode</label>
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 [#--col-lg-offset-1--] businessDaily_box">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: center">
                    ...
                    <span style="font-size: 25px;font-weight: bold">MM Promotion Sales Daily Report</span>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <table id="dailyTable" class="table table-condensed table-bordered zgrid-table"
                        ...
                        <tr>
                            <th title="Store No.">Store No.</th>[#--店铺编号--]
                            <th title="Store Name">Store<br> Name</th>[#--店铺名称--]
                            <th title="Date">Date</th>[#--营业日期--]
                            <th title="Promotion No.">Promotion<br> No.</th>[#--促销编号--]
                            <th title="Promotion Theme">Promotion<br> Theme</th>[#--促销主题--]
                            <th title="Promotion Pattern">Promotion<br> Pattern</th>[#--促销模式--]
                            <th title="Promotion Type">Promotion<br> Type</th>[#--促销类型--]
                            ...
                            <th title="Selling Price">Selling<br> Price</th>[#--售价, 分摊后--]
                            <th title="Selling Amount">Sales<br> Quantity</th>[#--销售数量--]
                            <th title="Selling Amount">Sales<br> Amount</th>[#--销售金额--]
                        </tr>
                    </table>
