...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.orderNewStore'/]"></script>
...
[#--												<input value="${data.storeCd!}" status="0" type="text" maxlength="6" nextele="order_date" class="form-control my-automatic input-sm detail-clear-input" id="input_store" placeholder="请输入完整的Store No.">--]
[#--												<a id="search_store_but" href="javascript:void(0);" title="点击查找店铺" class="auto-but glyphicon glyphicon-zoom-in  item-select-but "></a>--]
[#--											</div>--]
[#--										</div>--]
[#--										<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">--]
[#--											<span id="store_name"  class="text-muted p-line-height bm-code-text"></span>--]
[#--										</div>--]
[#--									</div>--]
									<div class="form-group">
...
[#--										<input id="order_date" disabled="disabled" nextele="" placeholder="Order Date" class="form-control input-sm select-date" type="text" value="">--]
								...
								<div class="form-group" id="show_status">
									...
									<div class="col-xs-11 col-sm-10 col-md-10 col-lg-11 col-xs-offset-1  col-sm-offset-0  col-md-offset-0 col-lg-offset-0 ">
										[#--											<div class="radio-inline " id="show_type_all">--]
										[#--												<label class="">--]
										[#--													<input type="radio" name="order_type" id="order_type_0"  value="0">--]
										[#--													全部--]
										[#--												</label>--]
										[#--											</div>--]
...
[#--									<label for="" class="col-sm-1 control-label">Top Department</label>--]
[#--									<div class="col-sm-2">--]
[#--										<select id="param_dep" class="form-control input-sm">--]
[#--											<option value="" selected>-- All/Please Select --</option>--]
[#--										</select>--]
[#--									</div>--]
[#--									<label for="param_pma"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Department</label>--]
[#--									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">--]
[#--										<select id="param_pma" class="form-control input-sm" nextele="param_category">--]
[#--											<option value="" selected>-- All/Please Select --</option>--]
[#--										</select>--]
[#--									</div>--]
[#--									<label for="param_category"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Category</label>--]
[#--									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">--]
[#--										<select id="param_category" class="form-control input-sm" nextele="param_subCategory">--]
[#--											<option value="">-- All/Please Select --</option>--]
[#--										</select>--]
[#--									</div>--]
[#--									<label for="param_subCategory"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Sub-Category</label>--]
[#--									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">--]
[#--										<select id="param_subCategory" class="form-control input-sm" nextele="">--]
[#--											<option value="">-- All/Please Select --</option>--]
[#--										</select>--]
[#--									</div>--]
								<!-- form-group -->
...
[#--									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">--]
[#--										<select id="param_shelf" class="form-control input-sm" nextele="subShelf">--]
[#--											<option value="">-- All/Please Select --</option>--]
[#--										</select>--]
[#--									</div>--]
									<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
...
[#--									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">--]
[#--										<select id="param_subShelf" class="form-control input-sm" nextele="">--]
[#--											<option value="">-- All/Please Select --</option>--]
[#--										</select>--]
[#--									</div>--]
									<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
