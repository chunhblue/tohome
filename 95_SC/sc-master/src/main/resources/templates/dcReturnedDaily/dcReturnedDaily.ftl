...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.ReturnedDailyWarehouse'/]"></script>
...
[#--	</div>--]
<!--导航-->
[@common.nav "HOME&Report&Store Returned Daily Report(To DC)"][/@common.nav]
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 [#--col-lg-offset-1--] businessDaily_box">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: center">
                    ...
                    <span style="font-size: 25px;font-weight: bold">Store Returned Daily Report(To DC)</span>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="row" style="overflow: scroll">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="width: 160%;">
                    <table id="dailyTable" class="table table-hover table-striped table-condensed table-bordered zgrid-table"
                        ...
                        <tr>
                            <th title="Document No." style="width: 8%;">Document No.</th>
                            ...
                            <th title="DC No.">DC No.</th>
                            <th title="DC Name" style="width: 8%;">DC Name</th>
