...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.ReturnedDailyWarehousePrint'/]"></script>
    ...
    <div class="table-box">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: center">
                <span style="font-size: 20px;font-weight: bold">Store Returned Daily Report(To DC)</span>
            </div>
        </div>
