...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.importantgoodsSaleReport'/]"></script>
...
[#--	</div>--]
<!--导航-->
[@common.nav "HOME&Report&Core Item Daily Report(By Company)"][/@common.nav]
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 [#--col-lg-offset-1--] businessDaily_box">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: center">
                    <span style="font-size: 25px;font-weight: bold">Core Item Daily Report(By Company)</span>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="width: 160%;">
                    <table id="dailyTable" class="table table-hover table-striped table-condensed table-bordered zgrid-table"
                        ...
                        <tr>
                            ...
                            <th title="Sort by Ranking">Sort by Ranking</th>
