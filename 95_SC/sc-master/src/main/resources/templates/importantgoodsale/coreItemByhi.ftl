...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.coreItemByhi'/]"></script>
...
<body>
<!--导航-->
[@common.nav "HOME&Report&Core Item Daily Report(By Hierarchy)"][/@common.nav]
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-horizontal">
                                     <div class="form-group">
                                        <label for="core_type" class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label not-null">Core Item Type</label>
                                        <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
                                            <select id="core_type" class="form-control input-sm">
                                                <option value="00">-- All/Please Select --</option>
                                            </select>
                                        </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <button id='export' type='button' class='btn btn-info btn-sm'><span class='glyphicon glyphicon-export icon-right'></span>Export</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 [#--col-lg-offset-1--] businessDaily_box">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: center">
                    <span style="font-size: 25px;font-weight: bold">Core Item Daily Report(By Hierarchy)</span>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <span style="float: left">Created By:<span id="author"></span>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
