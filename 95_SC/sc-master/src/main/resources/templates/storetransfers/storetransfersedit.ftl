...
<head>
	...
	<script src="${m.staticpath}/[@spring.message 'js.storeTransfersEdit'/]"></script>
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
										<select disabled id="dj_type" class="form-control input-sm">
											<option value="502" selected>Store Transfer Out</option>
										</select>
									</div>
								...
								<div class="form-group">
									<label for="vstore"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label not-null" autocomplete="off">From Store</label>
									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
									...
									<label for="tstore"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label not-null">To Store</label>
									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
										<div class="aotu-pos good-select">
...
<div hidden><input type="file" id="getFileData" value="" ></div>
