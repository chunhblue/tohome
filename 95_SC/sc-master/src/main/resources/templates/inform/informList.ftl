...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.informList'/]"></script>
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<div class="form-horizontal">
									<div class="form-group">
										...
										<label for="inform_title"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label" style="white-space: nowrap">Notification title</label>[#--通报标题--]
										<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
											<div class="aotu-pos">
									...
									<div class="form-group">
										<label for=""  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Business Date</label>[#--录入日期--]
...
[#--										</div>--]
	...
	[@permission code="SC-INF-HQ-001"]<input type="hidden" class="permission-verify" id="informButView" value="${displayVar!}" />[/@permission]
	[@permission code="SC-INF-HQ-002"]<input type="hidden" class="permission-verify" id="informButAdd" value="${displayVar!}" />[/@permission]
</body>
</html>
