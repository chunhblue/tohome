...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.vendorReturnPrint'/]"></script>
    ...
    <div class="table-box">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: center">
                <span style="font-size: 25px;font-weight: bold">Item Return Request Entry(To Supplier)</span>
            </div>
        </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <table id="grid_table" class="table table-hover table-striped table-condensed table-bordered zgrid-table" style="margin-bottom: 10px">
                    <tr>
                        <th>Date Returned</th>
                        <th>Document No.</th>
                        <th id="orgDoNo">Original Document No.</th>
                        <th>Supplier No.</th>
                        <th>Supplier Name</th>
                        <th>Store Name</th>
