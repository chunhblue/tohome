...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.returnVendorEdit'/]"></script>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group" id="indirectReturn" hidden>[#--原单号退货--]
                                    <label for="store_name"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Store Name</label>
                                    <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
                                        <input type="text" id="store_name" readonly="true" class="form-control input-sm" >
                                    </div>
                                    <label for="vendor_name_in"  class="col-xs-12 col-sm-3 col-md-2 col-lg-1 control-label" >Supplier No.</label>
                                    <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
                                        <input type="text" id="vendor_name_in" readonly="true" class="form-control input-sm">
                                    </div>
                                ...
                                <div class="form-group" id="directDC"> [#-- 直接退货 --]
                                    ...
                                    <label for="warehouseCd" class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label not-null">Supplier No.</label>
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                        <div class="aotu-pos">
                                            <input type="text" class="form-control my-automatic input-sm" placeholder="Please enter 3 digit " id="warehouseCd">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="vendor_id"  hidden class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Vendor Id</label>
                                    <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 hidden" >
                                        <input type="text" id="vendor_id" readonly="true" class="form-control input-sm" >
                                    </div>
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-horizontal">
                    <div class="form-group">
                        <label for="a_item"  class="col-sm-2 col-lg-4 control-label not-null">Item</label>
                        <div class="col-sm-6">
                            <div class="aotu-pos" id="itemDivOrg">
                                <input type="text" class="form-control my-automatic input-sm" id="a_item"  autocomplete="off" onmouseover="this.title=this.value">
[#--                                <input type="text" class="form-control my-automatic input-sm" id="a_item_direct"  placeholder="Please enter 3 digit" autocomplete="off" onmouseover="this.title=this.value">--]
					...
					<div class="form-group">
						<label for="orderQty" class="col-sm-2 col-lg-4 control-label not-null">Return Qty</label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group" hidden>
                        ...
                        <div class="col-sm-6">
                            <input type="text" id="receiveNochargeQty" class="form-control input-sm" autocomplete="off" disabled>
                        </div>
                    </div>
                    <div class="form-group" hidden>
                    ...
                    <div class="form-group" hidden>
                        <label for="isFreeItem" class="col-sm-2 col-lg-4 control-label">Item Type</label>
                        <div class="col-sm-6">
                            <input type="text" id="isFreeItem" class="form-control my-automatic input-sm" readonly="true">
                        </div>
                    </div>
                    <div class="form-group" hidden>
...
<input type="hidden" id="orderIdOrg" value="">
...
[#--<input type="hidden" id="hiddenorderNoChanger">--]
</body>
</html>
