...
<head>
	...
	<script src="${m.staticpath}/[@spring.message 'js.returnWarehouse'/]"></script>
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="form-horizontal">
								...
								<div class="form-group">
									<label for="delivery_center_id"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label" style="white-space: nowrap">DC</label>
									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
										<div class="aotu-pos">
											<input type="text" class="form-control my-automatic input-sm" id="delivery_center_id"  autocomplete="off">
											<a id="centerIdRefresh" href="javascript:void(0);" title="Refresh" class="auto-but glyphicon glyphicon-refresh refresh"></a>
											<a id="centerIdRemove" href="javascript:void(0);" title="Clear" class="auto-but glyphicon glyphicon-remove circle"></a>
										</div>
									</div>
...
[@permission code="SC-W-RETURN-001"]<input type="hidden" class="permission-verify" id="viewButPm" value="${displayVar!}" />[/@permission]
[@permission code="SC-W-RETURN-002"]<input type="hidden" class="permission-verify" id="editButPm" value="${displayVar!}" />[/@permission]
[@permission code="SC-W-RETURN-003"]<input type="hidden" class="permission-verify" id="addButPm" value="${displayVar!}" />[/@permission]
[@permission code="SC-W-RETURN-005"]<input type="hidden" class="permission-verify" id="exportButPm" value="${displayVar!}" />[/@permission]
[@permission code="SC-W-RETURN-006"]<input type="hidden" class="permission-verify" id="printButPm" value="${displayVar!}" />[/@permission]
[@permission code="SC-W-RETURN-007"]<input type="hidden" class="permission-verify" id="approvalRecordButPm" value="${displayVar!}" />[/@permission]
</body>
</html>
