...
<head>
	...
	<script src="${m.staticpath}/[@spring.message 'js.receiptReturnWarehouse'/]"></script>
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="form-horizontal">
								...
								<div class="form-group">
									<label for=""  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label not-null">Date Returned </label>
								...
								<div class="form-group">
									<label for="delivery_center_id"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">DC</label>
									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
										<div class="aotu-pos">
									...
									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
										<select id="reviewStatus" class="form-control input-sm">
											...
											<option value="20">Returned</option>
										</select>
									</div>
									<label for="status" class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label" style="white-space: nowrap">Status</label>
									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
...
[@permission code="SC-RW-001"]<input type="hidden" class="permission-verify" id="viewBut" value="${displayVar!}" />[/@permission]
[@permission code="SC-RW-002"]<input type="hidden" class="permission-verify" id="editBut" value="${displayVar!}" />[/@permission]
[@permission code="SC-RW-004"]<input type="hidden" class="permission-verify" id="printBut" value="${displayVar!}" />[/@permission]
[@permission code="SC-RW-005"]<input type="hidden" class="permission-verify" id="exportBut" value="${displayVar!}" />[/@permission]
[@permission code="SC-RW-006"]<input type="hidden" class="permission-verify" id="approvalBut" value="${displayVar!}" />[/@permission]
</body>
</html>
