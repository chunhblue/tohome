...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.receiptReturnVendorEdit'/]"></script>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="vendor_name"  class="col-xs-12 col-sm-3 col-md-2 col-lg-1 control-label" >Supplier No</label>
                                    <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
                                        <input type="text" id="vendor_name" readonly="true" class="form-control input-sm">
                                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="orderQty" class="col-sm-2 col-lg-4 control-label">Return Qty</label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group" hidden>
                        <label for="orderNochargeQty" class="col-sm-2 col-lg-4 control-label">Order Free  Qty</label>
                        <div class="col-sm-6">
                            <input type="text" id="orderNoChargeQty" class="form-control input-sm" readonly="true" autocomplete="off" disabled>
                        </div>
                    </div>
                    <div class="form-group">
