...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.receiptReturnVendor'/]"></script>
...
<body>
<!--导航-->
[@common.nav "HOME&Receiving&Item Return Entry(To Supplier)"][/@common.nav]
...
[@permission code="SC-RV-001"]<input type="hidden" class="permission-verify" id="viewBut" value="${displayVar!}" />[/@permission]
[@permission code="SC-RV-002"]<input type="hidden" class="permission-verify" id="editBut" value="${displayVar!}" />[/@permission]
[@permission code="SC-RV-004"]<input type="hidden" class="permission-verify" id="printBut" value="${displayVar!}" />[/@permission]
[@permission code="SC-RV-005"]<input type="hidden" class="permission-verify" id="exportBut" value="${displayVar!}" />[/@permission]
[@permission code="SC-RV-006"]<input type="hidden" class="permission-verify" id="approvalBut" value="${displayVar!}" />[/@permission]
</body>
</html>
