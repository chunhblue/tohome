...
<head>
	...
	<script src="${m.staticpath}/[@spring.message 'js.vendorReceiptEdit'/]"></script>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                        <input type="text" id="receiveDate" readonly="true" class="form-control input-sm" >
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="warehouseName" class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Vendor</label>
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
