...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.receipt'/]"></script>
...
[#--	</div>--]
	...
	<!--导航-->
	[@common.nav "HOME&Receiving&Item Receiving Entry(From DC)"][/@common.nav]
...
[#--										</div>--]
									...
									<div class="form-group">
[#--									    <label for="" class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Receiving Date</label>--]
...
[#--									    </div>--]
                                        ...
                                        <label for="warehouseCd" class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Warehouse</label>
                                        <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                            <div class="aotu-pos">
									...
									<div class="form-group">
										<label for="" class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label" hidden="true">Delivery Date</label>
										<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2"  hidden="true">
[#--											<input id="ck_start_date" readonly="true" nextele="ck_end_date" placeholder="Start Date" class="form-control input-sm select-date" type="text" value="">--]
										...
										<label for="" class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label"  hidden="true"></label>
										<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2"  hidden="true">
[#--											<input  id="ck_end_date" readonly="true" placeholder="End Date" class="form-control input-sm select-date" type="text" value="">--]
	...
	[@permission code="SC-RECEIPT-001"]<input type="hidden" class="permission-verify" id="viewBut" value="${displayVar!}" />[/@permission]
	[@permission code="SC-RECEIPT-002"]<input type="hidden" class="permission-verify" id="confirmBut" value="${displayVar!}" />[/@permission]
	[@permission code="SC-RECEIPT-003"]<input type="hidden" class="permission-verify" id="receiveBut" value="${displayVar!}" />[/@permission]
	[@permission code="SC-RECEIPT-005"]<input type="hidden" class="permission-verify" id="printBut" value="${displayVar!}" />[/@permission]
	[@permission code="SC-RECEIPT-006"]<input type="hidden" class="permission-verify" id="exportBut" value="${displayVar!}" />[/@permission]
	[@permission code="SC-RECEIPT-007"]<input type="hidden" class="permission-verify" id="approvalBut" value="${displayVar!}" />[/@permission]
</body>
</html>
