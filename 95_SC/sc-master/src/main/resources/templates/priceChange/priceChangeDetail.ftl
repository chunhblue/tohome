...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.priceChangeDetail'/]"></script>
...
[#--   </div>--]
	<!--导航-->
	[@common.nav "HOME&Sale&Urgent Price Info Update Query"][/@common.nav]
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<div class="form-horizontal">
									...
									<div class="form-group">
										<label for="articleId"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Item Code</label>
										<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
