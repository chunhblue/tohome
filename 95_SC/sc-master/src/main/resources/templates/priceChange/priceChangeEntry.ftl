...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.priceChange'/]"></script>
...
[#--   </div>--]
	<!--导航  紧急变价申请登录-->
	[@common.nav "HOME&Sale&Urgent Price Info Update Entry"][/@common.nav]
	<div class="container-fluid" id="main_box">
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<div class="form-horizontal">
									...
									<div class="form-group ">
										<label for="oldPrice"  class="col-xs-12 col-sm-2 col-md-2 col-lg-3 control-label" >Current Selling Price</label>
										<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
											<input type="text" class="form-control my-automatic input-sm" id="oldPrice" placeholder="" readonly="readonly">
										</div>

										<label for="newPrice" class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label not-null">New Selling Price</label>[#--新售价--]
										<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
											<input type="text" class="form-control my-automatic input-sm" id="newPrice" placeholder="">
										</div>
									</div>
								</div>
							</div>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
				<button id="nextBtn" type="button" class="btn btn-default returnsViewBut"><span class="glyphicon glyphicon-chevron-right icon-right">Next</span></button>[#--录入下一张变价单--]
	...
	<div class="modal-dialog modal-md" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Price Change Maintenance</h4><!--紧急变价维护-->
			</div>
