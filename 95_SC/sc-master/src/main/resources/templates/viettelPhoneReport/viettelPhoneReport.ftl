...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.viettelPhoneReport'/]"></script>
...
[#--	</div>--]
<!--导航-->
[@common.nav "HOME&Report&Viettel Phone Report"][/@common.nav]
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 [#--col-lg-offset-1--] businessDaily_box">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: center">
                     <span style="font-size: 25px;font-weight: bold">Viettel Phone Report</span>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <table id="dailyTable" class="table table-hover table-striped table-condensed table-bordered zgrid-table"
                        ...
                        <tr>
                            ...
                            <th title="Request ID.">Request ID.</th>
                            <th title="Order ID.">Order ID.</th>
                            <th title="Receipt No.">Receipt No.</th>
                            <th title="Department">Trans Amt</th>
