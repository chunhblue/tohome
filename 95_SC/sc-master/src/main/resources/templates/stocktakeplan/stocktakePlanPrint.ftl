...
<html lang="zh-CN">
<head>
    <title>Start Stocktaking Print</title>
    <meta charset="utf-8">
    ...
    <script src="${m.staticpath}/[@spring.message 'js.stocktakePlanPrint'/]"></script>
    ...
    <div class="table-box">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: center">
                <span style="font-size: 20px;font-weight: bold">Start Stocktaking</span>
            </div>
        </div>
