...
<head>
	...
	<script src="${m.staticpath}/[@spring.message 'js.stocktakePlan'/]"></script>
...
[@permission code="SC-PD-SETTING-001"]<input type="hidden" class="permission-verify" id="addButPm" value="${displayVar!}" />[/@permission]
[@permission code="SC-PD-SETTING-002"]<input type="hidden" class="permission-verify" id="editButPm" value="${displayVar!}" />[/@permission]
[@permission code="SC-PD-SETTING-003"]<input type="hidden" class="permission-verify" id="viewButPm" value="${displayVar!}" />[/@permission]
[@permission code="SC-PD-SETTING-004"]<input type="hidden" class="permission-verify" id="printButPm" value="${displayVar!}" />[/@permission]
[@permission code="SC-PD-SETTING-005"]<input type="hidden" class="permission-verify" id="exportBasicButPm" value="${displayVar!}" />[/@permission]
[@permission code="SC-PD-SETTING-006"]<input type="hidden" class="permission-verify" id="exportItemButPm" value="${displayVar!}" />[/@permission]
[@permission code="SC-PD-SETTING-008"]<input type="hidden" class="permission-verify" id="approvalBut" value="${displayVar!}" />[/@permission]
</body>
</html>
