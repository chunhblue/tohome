...
<script src="${m.staticpath}/[@spring.message 'js.orderReport'/]"></script>
    <STYLE>
...
<body>
[@common.nav "HOME&Report&Store Order Daily Report"][/@common.nav]
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                        <input id="order_date" nextele="sell_end_date" placeholder="Order Date" class="form-control input-sm select-date"  type="text" value="">
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                        <input type="text" class="form-control input-sm" id="articleName">
                                    </div>
                                </div><!-- form-group -->
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 [#--col-lg-offset-1--] businessDaily_box">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: center">
                    <span style="font-size: 25px;font-weight: bold">Store Order Daily Report</span>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <table id="dailyTable" class="table table-hover table-striped table-condensed table-bordered zgrid-table"
                        ...
                        <tr>
                            ...
                            <th title="UOM">UOM</th>
                            <th title="AI SOQ">AI SOQ</th>
                            <th title="Real Ordered">Real Ordered</th>
                            <th title="Variance">Variance %</th>
                            <th title="Sales PSD(Units)">Sales PSD(Units)</th>
                        </tr>
                    </table>
