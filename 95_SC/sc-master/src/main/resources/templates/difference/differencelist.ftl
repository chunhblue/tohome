...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.difference'/]"></script>
...
<body>
<!--导航-->
	[@common.nav "HOME&Ordering&Delivery Variance Query"][/@common.nav]
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<div class="form-horizontal">
									...
									<div class="form-group">
										<label for=""  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Date Ordered</label>
										<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
											<input id="od_start_date"  placeholder="Start Date" class="form-control input-sm select-date" type="text" value="">
										</div>
										<label for=""  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label"></label>
										<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
											<input  id="od_end_date"   placeholder="End Date" class="form-control input-sm select-date" type="text" value="">
										</div>

										<label for=""  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Document Date</label>
										<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
											<input id="vd_start_date"  placeholder="Start Date" class="form-control input-sm select-date" type="text" value="">
										</div>
										<label for=""  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label"></label>
										<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
											<input  id="vd_end_date"  placeholder="End Date" class="form-control input-sm select-date" type="text" value="">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
											<div class="radio-inline"><label><input type="radio" name="query_type" id="vendor"value="0" checked="checked">Vendor</label></div>
											<div class="radio-inline"><label><input type="radio" name="query_type" id="dc" value="1"/>DC</label></div>
										</div>
