...
<head>
	...
	<script src="${m.staticpath}/[@spring.message 'js.differenceEdit'/]"></script>
...
<body>
<!--导航-->
[@common.nav "HOME&Ordering&Delivery Variance Detail"][/@common.nav]
							...
							<div class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
										<input type="text" id="store_cd" class="form-control input-sm" value="${storeCd}">
									</div>

									<label for=""  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Date Ordered</label>
									<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
										<input id="order_date" placeholder="Order Date" class="form-control input-sm select-date" type="text" value="">
									</div>
								</div>
								<div class="form-group">
									<label for=""  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Total Variance Quantity</label>
									<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
