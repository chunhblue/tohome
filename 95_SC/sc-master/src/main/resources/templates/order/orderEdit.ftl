...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.orderEdit'/]"></script>
...
[@common.header][/@common.header]
<!--导航-->
[@common.nav "HOME&Ordering&Order New Store Detail"][/@common.nav]
<div class="container-fluid" id="main_box">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <label for="" class="col-xs-4 col-sm-2 col-md-2 col-lg-1 control-label" hidden>Order
                                        Date</label>
                                    <div class="col-xs-8 col-sm-3 col-md-2 col-lg-2" hidden>
                                        <input type="text" id="order_date" class="form-control input-sm"
                                               value="${data.orderDate?substring(6,8)}/${data.orderDate?substring(4,6)}/${data.orderDate?substring(0,4)}"
                                               readonly="true" style="text-align: center;">
                                    </div>
                                    <label for=""
                                           class="col-xs-4 col-sm-2 col-md-2 col-lg-1 control-label">Store</label>
                                    ...
                                    <div class="col-xs-8 col-sm-3 col-md-2 col-lg-2">
                                        <input type="text" id="store_name" class="form-control input-sm"
                                               value="${data.storeName!}" readonly="true">
                                    </div>

                                    [#if data.orderType=="1"]
                                        <label for="" class="col-xs-4 col-sm-2 col-md-2 col-lg-1 control-label">Top
                                            Department</label>
                                        <div class="col-xs-8 col-sm-3 col-md-2 col-lg-2">
                                            <input type="text" id="dep" class="form-control input-sm"
                                                   value="${data.depName!}" readonly="true">
                                        </div>
                                        <label for="" class="col-xs-4 col-sm-2 col-md-2 col-lg-1 control-label">Department</label>
                                        <div class="col-xs-8 col-sm-3 col-md-2 col-lg-2">
                                            <input type="text" id="pma" class="form-control input-sm"
                                                   value="${data.pmaName!}" readonly="true">
                                        </div>
                                    [#elseif data.orderType=="2"]
                                        <label for=""
                                               class="col-xs-4 col-sm-2 col-md-2 col-lg-1 control-label">Shelf</label>
                                        <div class="col-xs-8 col-sm-3 col-md-2 col-lg-2">
                                            <input type="text" id="shelf" class="form-control input-sm"
                                                   value="${data.shelf!}" readonly="true">
                                        </div>
                                    [/#if]
                                </div><!-- form-group -->
                            </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="aotu-pos">
                                            ...
                                            <a id="" href="javascript:void(0);" title="Refresh"
                                               class="auto-but glyphicon glyphicon-refresh refresh"></a>
                                            <a id="vendorIdRemove" href="javascript:void(0);" title="Clear"
                                               class="auto-but glyphicon glyphicon-remove circle"></a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-horizontal" id="item_info">
                                <div class="form-group">
                                    <label for="articleId" class="col-xs-4 col-sm-2 col-md-4 col-lg-4 control-label">Item
                                        Code</label>
                                ...
                                <div class="form-group">
                                    <label for="preserveTypeName"
                                           class="col-xs-4 col-sm-2 col-md-4 col-lg-4 control-label">Storage
                                        Condition</label>
                                    <div class="col-xs-8 col-sm-3 col-md-6 col-lg-6">
                                        <input type="text" id="preserveTypeName" class="form-control input-sm"
                                               readonly="true">
                                    </div>
                                </div><!-- form-group -->
                                ...
                                <div class="form-group">
                                    <label for="unitName" class="col-xs-4 col-sm-2 col-md-4 col-lg-4 control-label">Order
                                        UOM</label>
                                    <div class="col-xs-8 col-sm-3 col-md-6 col-lg-6">
                                ...
                                <div class="form-group">
                                    <label for="minOrderQty" class="col-xs-4 col-sm-2 col-md-4 col-lg-4 control-label"
                                           id="label_minOrderQty">DC MOQ</label>
                                    <div class="col-xs-8 col-sm-3 col-md-6 col-lg-6">
                                        <input type="text" id="minOrderQty" class="form-control input-sm"
                                               readonly="true">
                                    </div>
                                </div><!-- form-group -->
                                <div class="form-group">
                                    [#--订货批量--]
                                    <label for="orderBatchQty"
                                           class="col-xs-4 col-sm-2 col-md-4 col-lg-4 control-label">Incremental
                                        Quantity</label>
                                    <div class="col-xs-8 col-sm-3 col-md-6 col-lg-6">
                                        <input type="text" id="orderBatchQty" class="form-control input-sm"
                                               readonly="true">
                                    </div>
                                    <label for="maxOrderQty" class="col-xs-4 col-sm-2 col-md-4 col-lg-4 control-label"
                                           hidden>Max. Order Qty</label>
                                    <div class="col-xs-8 col-sm-3 col-md-6 col-lg-6" hidden>
                                        <input type="text" id="maxOrderQty" class="form-control input-sm"
                                               readonly="true">
                                    </div>
                                </div>
                                <div class="form-group" hidden>
                                    ...
                                    <div class="col-xs-8 col-sm-3 col-md-6 col-lg-6">
                                        <input type="text" id="orderPromotionType" class="form-control input-sm"
                                               readonly="true">
                                    </div>
                                </div><!-- form-group -->
                                <div class="form-group">
                                    <label for="minDisplayQty"
                                           class="col-xs-4 col-sm-2 col-md-4 col-lg-4 control-label">Qty on
                                        Shelf</label>
                                    <div class="col-xs-8 col-sm-3 col-md-6 col-lg-6">
                                        <input type="text" id="minDisplayQty" class="form-control input-sm"
                                               readonly="true">
                                    </div>
                                </div>
                                <div class="form-group" hidden>
                                    ...
                                    <div class="col-xs-8 col-sm-3 col-md-6 col-lg-6">
                                        <input type="text" id="adviseSalePrice" class="form-control input-sm"
                                               readonly="true">
                                    </div>
                                </div><!-- form-group -->
                                <div class="form-group">
                                    <label for="dms" class="col-xs-4 col-sm-2 col-md-4 col-lg-4 control-label"
                                           style="white-space:nowrap">Avg. Sales Amount DMS</label>
                                    <div class="col-xs-8 col-sm-3 col-md-6 col-lg-6">
                                ...
                                <div class="form-group">
                                    <label for="warrantyDays" class="col-xs-4 col-sm-2 col-md-4 col-lg-4 control-label">Shelf
                                        Life(day)</label>
                                    <div class="col-xs-8 col-sm-3 col-md-6 col-lg-6">
                                        <input type="text" id="warrantyDays" class="form-control input-sm"
                                               readonly="true">
                                    </div>
                                </div><!-- form-group -->
                                <div class="form-group" hidden>
                                    <label for="orderQty" class="col-xs-4 col-sm-2 col-md-4 col-lg-4 control-label">Order
                                        Qty</label>
                                    <div class="col-xs-8 col-sm-3 col-md-6 col-lg-6">
                                    ...
                                    <div class="col-sm-2 col-md-1 col-lg-1">
                                        <button id="updateOrderQty" type="button" class="btn btn-primary btn-sm"><span
                                                    class="glyphicon glyphicon-ok icon-right"></span>Order
                                        </button>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="promotionDescription"
                                           class="col-xs-4 col-sm-2 col-md-4 col-lg-4 control-label"
                                           style="white-space: nowrap">Promotion Description</label>
                                    <div class="col-xs-8 col-sm-3 col-md-6 col-lg-6">
                                        <input type="text" id="promotionDescription" class="form-control input-sm"
                                               readonly="true">
                                    </div>
                                </div><!-- form-group -->
                            </div>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
            ...
            <button id="submitBut" type="button" class="btn btn-default submitBut"><span
                        class="glyphicon glyphicon-ok icon-right"></span>Save
            </button>
            <button id="submitAuditBut" type="button" class="btn btn-default submitBut"><span
                        class="glyphicon glyphicon-saved icon-right"></span>Submit
            </button>
            <button id="approvalBut" type="button" class="btn btn-default returnsViewBut"><span
                        class="glyphicon glyphicon-paperclip icon-right"></span>Approval
            </button>
            <button id="returnsViewBut" type="button" class="btn btn-default returnsViewBut"><span
                        class="glyphicon glyphicon-share icon-right"></span>Back
            </button>
        </div>
    </div><!--row 分割-->
</div>
<div id="orderAdd_dialog" class="modal fade bs-example-modal-md" data-backdrop="static"
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <div class="aotu-pos">
                                <input type="text" class="form-control my-automatic input-sm"
                                       id="i_articleId" placeholder="">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <div class="aotu-pos">
                                <input type="text" class="form-control my-automatic input-sm"
                                       id="i_articleName" placeholder="">
                            </div>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="i_realtimeStock" class="col-sm-5 control-label">Real-time
                            Inventory</label>
                        <div class="col-sm-5">
                            <div class="aotu-pos">
                                <input type="text" class="form-control my-automatic input-sm"
                                       id="i_realtimeStock" placeholder="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group" id="psd">
                        ...
                        <div class="col-sm-5">
                            <div class="aotu-pos">
                                <input type="text" class="form-control my-automatic input-sm"
                                       id="i_psd" placeholder="">
                            </div>
                        </div>
                    </div>

                    <div class="form-group" id="autoOrderQty">
                        <label for="i_autoOrderQty" class="col-sm-5 control-label">Recommended Order
                            Qty</label>
                        <div class="col-sm-5">
                            <div class="aotu-pos">
                                <input type="text" class="form-control my-automatic input-sm"
                                       id="i_autoOrderQty" placeholder="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <div class="aotu-pos">
                                <input type="text" class="form-control my-automatic input-sm"
                                       id="i_orderQty" placeholder="">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">[#--Min. Order Qty--]
                        <label for="i_minOrderQty" class="col-sm-5 control-label"
                               id="label_i_minOrderQty">DC MOQ</label>
                        <div class="col-sm-5">
                            <div class="aotu-pos">
                                <input type="text" class="form-control my-automatic input-sm"
                                       id="i_minOrderQty" placeholder="" readonly="readonly">
                            </div>
                        </div>
                    </div>
                    <div class="form-group" hidden>
                        <label for="i_maxOrderQty" class="col-sm-5 control-label">Max. Order
                            Qty</label>
                        <div class="col-sm-5">
                            <div class="aotu-pos">
                                <input type="text" class="form-control my-automatic input-sm"
                                       id="i_maxOrderQty" placeholder="" readonly="readonly">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="i_orderBatchQty" class="col-sm-5 control-label">Incremental
                            Quantity</label>
                        <div class="col-sm-5">
                            <div class="aotu-pos">
                                <input type="text" class="form-control my-automatic input-sm"
                                       id="i_orderBatchQty" placeholder="" readonly="readonly">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                ...
                <button id="cancel" type="button" class="btn btn-default btn-sm"
...
[@permission code="SC-ORDER-002"]<input type="hidden" class="permission-verify" id="orderButEdit"
