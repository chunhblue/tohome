...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.itemList'/]"></script>
...
[#--   </div>--]
	<!--导航-->
	[@common.nav "HOME&Master&Item Master Query"][/@common.nav]
								...
								<div class="form-horizontal">
									<div class="form-group">
									    ...
									    <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
											<input id="itemCode" class="form-control" type="text" value="">
									    </div>
                                        <label for="itemName" class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Item Name</label>
                                        <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
                                            <input id="itemName" class="form-control" type="text" value="">
                                        </div>

										<label for="itemType" class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Material Type</label>
										<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
										...
										<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
											<div class="aotu-pos">
												<input type="text" class="form-control my-automatic input-sm" placeholder="Please enter 2 digits" autocomplete="off" id="brand">
												<a id="brandRefresh" href="javascript:void(0);" title="Refresh" class="auto-but glyphicon glyphicon-refresh refresh"></a>
												<a id="brandRemove" href="javascript:void(0);" title="Clear" class="auto-but glyphicon glyphicon-remove circle"></a>
											</div>
										</div>
									</div><!-- form-group -->
									...
									<div class="form-group">
										<label for="barcode" class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Barcode Code</label>
...
[#--	<input type="hidden" id="checkResources" value="${checkResources!}"/>--]
    ...
    [@permission code="SC-ZD-IMQ-001"]<input type="hidden" class="permission-verify" id="viewBut" value="${displayVar!}" />[/@permission]
    [@permission code="SC-ZD-IMQ-003"]<input type="hidden" class="permission-verify" id="exportBut" value="${displayVar!}" />[/@permission]
</body>
</html>
