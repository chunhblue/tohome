...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.customerCountReport'/]"></script>
...
<body>
[@common.nav "HOME&Report&Customer Count By Receipt With Service At Store-HCM"][/@common.nav]
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 [#--col-lg-offset-1--] businessDaily_box">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: center">
                <span style="font-size: 25px;font-weight: bold">Customer Count By Receipt With Service At Store-HCM</span>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <table id="dailyTable" class="table table-hover table-striped table-condensed table-bordered zgrid-table"
                    ...
                    <tr>
                        ...
                        <th title="1K<=Bill<19K">1K<=Bill<19K</th>
                        <th title="19k<=Bill<29K">19k<=Bill<29K</th>
                        <th title="29k<=Bill<39K">29k<=Bill<39K </th>
                        <th title="39k<=Bill<49K">39k<=Bill<49K</th>
                       <th title="Bill>49K">Bill>49K</th>
