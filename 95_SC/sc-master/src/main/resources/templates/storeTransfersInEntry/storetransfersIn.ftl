...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.storeTransfersIn'/]"></script>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    [#--									</div>--]
                                    <label for="storeCdTo"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label" style="white-space: nowrap">Transfer From Store</label>
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
