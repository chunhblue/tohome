...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.storeTransfersInEdit'/]"></script>
...
<!--导航-->
[@common.nav "HOME&Inventory&Store Transfer In Entry"][/@common.nav]
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="collapse">
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                            <select disabled id="dj_type" class="form-control input-sm">
                                                <option value="501" selected>Store Transfer In</option>
                                            </select>
                                        </div>
                                ...
                                <div class="form-group">
                                    <label for="vstore"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label not-null">To Store</label>
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                        <div class="aotu-pos good-select">
                                            <input type="text" class="form-control my-automatic input-sm" id="vstore" autocomplete="off">
                                    ...
                                    <label for="tstore"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label not-null">From Store</label>
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                        <div class="aotu-pos good-select">
                                            <input type="text" class="form-control my-automatic input-sm" id="tstore" autocomplete="off">
                                            <a id="tstoreRefresh" href="javascript:void(0);" title="Refresh" class="auto-but glyphicon glyphicon-refresh refresh"></a>
                                            <a id="tstoreRemove" href="javascript:void(0);" title="Clear" class="auto-but glyphicon glyphicon-remove circle"></a>
                                        </div>
                                    </div>
                                    <label for="out_cd"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label not-null">Tranfer Out Document No.</label>
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                        <div class="aotu-pos good-select">
                                            <input type="text" class="form-control my-automatic input-sm" id="out_cd" autocomplete="off">
                                            <a id="outcdRefresh" href="javascript:void(0);" title="Refresh" class="auto-but glyphicon glyphicon-refresh refresh"></a>
                                            <a id="outcdRemove" href="javascript:void(0);" title="Clear" class="auto-but glyphicon glyphicon-remove circle"></a>
                                        </div>
                                    </div>
                                ...
                                [#--<div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                        <input id="ap_date" readonly="true" placeholder="Date Approved" class="form-control input-sm" type="text" value="">
                                    </div>
                                </div>--]
                            </div>
                        </div>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="form-horizontal" >
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-group">
                                <label for="item_input"  class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label not-null">Item</label>
                                <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                    <div class="aotu-pos good-select">
                                        <input type="text" class="form-control my-automatic input-sm" placeholder="Please enter 3 digit" id="item_input" style="overflow:scroll;text-overflow:ellipsis;" required>
                            ...
                            <div class="form-group">
                                <label for="differeQty"  class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label">Variance Qty</label>
                                <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                    <input type="text" id="differeQty" disabled class="form-control input-sm">
                                </div>
[#--                            </div>--]
                                [#--								<label for="adjustReason" class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label not-null">Transfer Reason</label>--]
                                [#--								<div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">--]
                                [#--									<select id="adjustReason" class="form-control input-sm">--]
                                [#--										<option value="">-- All/Please Select --</option>--]
                                [#--									</select>--]
                                [#--
                                								</div>--]
                            ...
                            <div class="form-group">
                                <label for="differenceReason"  class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label">Differnece Reason</label>
                                <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                    <div class="aotu-pos good-select">
...
<input type="hidden" id="_voucherNo1" value="${data.voucherNo1!}"/>
<input type="hidden" id="toKen" value="${toKen!}"/>
<input type="hidden" id="typeId" value="${typeId!}">
<input type="hidden" id="reviewId" value="${reviewId!}">
<input type="hidden" id="nouthOrsouth" value="">
</body>
</html>
