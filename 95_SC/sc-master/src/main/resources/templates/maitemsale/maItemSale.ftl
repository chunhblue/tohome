...
<head>
	...
	<script src="${m.staticpath}/[@spring.message 'js.maItemSale'/]"></script>
...
[#--	</div>--]
	<!--导航-->
[@common.nav "HOME&Sale&Material Item Sales Query"][/@common.nav]
							...
							<div class="form-horizontal">
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
										<input type="text" id="voucher_cd" class="form-control input-sm">
									</div>
									<label for="sale_start_date"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label not-null">Selling Date</label>
									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
										<input id="sale_start_date" nextele="sale_end_date" placeholder="Start Date" class="form-control input-sm select-date" type="text" value="">
									</div>
									<label for="sale_end_date"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label not-null"></label>
									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
										<input  id="sale_end_date" placeholder="End Date" class="form-control input-sm select-date" type="text" value="">
									</div>
								...
								<div class="form-group">
									<label for="formulaArticleId"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Parent Item Code</label>
									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
										<input type="text" id="formulaArticleId" class="form-control input-sm">
									</div>
									<label for="formulaArticleName"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Parent Item Name</label>
									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
										<input type="text" id="formulaArticleName" class="form-control input-sm">
									</div>
									...
									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
										<input type="text" id="posId" class="form-control input-sm">
									</div>
								</div>
							</div>
						</div>
...
[@permission code="SC-XS-ORDER-001"]<input type="hidden" class="permission-verify" id="viewBut" value="${displayVar!}" />[/@permission]
[@permission code="SC-XS-ORDER-003"]<input type="hidden" class="permission-verify" id="exportBut" value="${displayVar!}" />[/@permission]
</body>
</html>
