...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.promotionList'/]"></script>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label for="redioCustomer"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label" style="text-align: left; white-space: nowrap" >
                                        <input type="radio" name="date" value="1" id="redioCustomer" >
                                        Promotion Date
                                    </label>
                                    ...
                                    <label for="dep_cd"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label" style="white-space: nowrap">Top Department</label>
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                        <select id="dep_cd" class="form-control input-sm">
                                ...
                                <div class="form-group">
                                    <label for="redioEntry"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label" style="text-align: left; white-space: nowrap">
                                        <input type="radio" name="date" value="3" id="redioEntry" >
                                        Date Created
                                    </label>
                                    <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
                                        <input id="entry_start_date" placeholder="Start Date" class="form-control input-sm select-date" type="text" value="">
                                    </div>
                                    <label class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label"></label>
                                    <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
                                        <input id="entry_end_date" placeholder="End Date" class="form-control input-sm select-date" type="text" value="">
                                    </div>

                                    <label for="item_code"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Item Code</label>
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                        <div class="aotu-pos">
                                            <input type="text" class="form-control input-sm" id="item_code" placeholder="" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                        <div class="aotu-pos">
                                            <input type="text" class="form-control input-sm" id="item_name" placeholder="" >
                                        </div>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="informType" class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label" style="text-align: left;">Informaition Status</label>
                                    <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
                                        <select id="informType" class="form-control input-sm">
...
[@permission code="SC-PROMOTION-001"]<input type="hidden" class="permission-verify" id="promotionButView" value="${displayVar!}" />[/@permission]
</body>
</html>
