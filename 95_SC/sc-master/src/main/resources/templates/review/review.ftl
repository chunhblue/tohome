...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.review'/]"></script>
								...
								<div class="form-horizontal">
									<div class="form-group">
										...
										<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
											<input type="text" id="c_reviewcode" class="form-control input-sm">
										</div>
										<label for="n_typeid"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Approval Type</label>
										<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
											<select id="n_typeid" class="form-control input-sm">
												<option value="">-- All/Please Select --</option>
											</select>
										</div>
										<label for="c_reviewname"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Approval Name</label>
										<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
