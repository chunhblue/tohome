...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.vendorReceiptDailyPrint'/]"></script>
    ...
    <div class="table-box">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: center">
                <span style="font-size: 20px;font-weight: bold">Store Receiving Daily Report(To Supplier)</span>
            </div>
        </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <table id="grid_table" class="table table-hover table-striped table-condensed table-bordered zgrid-table" style="margin-bottom: 10px">
                    <tr>
                        ...
                        <th title="Operation Manager Name">Operation<br>Manager Name</th>
