...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.vendorReceiptDaily'/]"></script>
...
[#--	</div>--]
<!--导航-->
[@common.nav "HOME&Report&Store Receiving Daily Report(To Supplier)"][/@common.nav]
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label for=""  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label not-null">Submission Date</label>
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                        <input  id="receiveId" class="form-control input-sm" type="text" >
                                    </div>
                                </div>
                                <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 [#--col-lg-offset-1--] businessDaily_box">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: center">
                    ...
                    <span style="font-size: 25px;font-weight: bold">Store Receiving Daily Report(To Supplier)</span>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="width: 140%;">
                    <table id="dailyTable" class="table table-hover table-striped table-condensed table-bordered zgrid-table"
                        ...
                        <tr>
                            ...
                            <th title="Area Manager Name" style="width: 8%;">Area<br>Manager Name</th>
                            <th title="Operation Manager Name" style="width: 8%;">Operation<br>Manager Name</th>
