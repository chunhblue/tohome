...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.staffAttendanceReport'/]"></script>
    <STYLE>
...
<!--导航-->
[@common.nav "HOME&Report&Store Staff Attendance Detail Report HCM"][/@common.nav]
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <label for=""  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label not-null" style="white-space: nowrap">In Date</label>
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 [#--col-lg-offset-1--] businessDaily_box">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: center">
                <span style="font-size: 25px;font-weight: bold">Store Staff Attendance Detail Report HCM</span>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <table id="dailyTable" class="table table-hover table-striped table-condensed table-bordered zgrid-table"
                    ...
                    <tr>
                        <th title="DateIn">Date In</th>
                        <th title="Staff Code">Staff Code</th>
                        <th title="Staff Name">Staff Name</th>
                        <th title="DateIn1">Date In1</th>
                        <th title="TimeIn">Time In</th>
                        <th title="DateOut">Date Out</th>
                        <th title="TimeOut">Time Out</th>
                        <th title="Hour Worked">Hour Worked</th>
                        <th title="Shift">Shift</th>
                    </tr>
                </table>
