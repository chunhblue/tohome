...
[#--   </div>--]
<!--导航-->
[@common.nav "HOME&Sale&Operations Daily Report"][/@common.nav]
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 [#--col-lg-offset-1--] businessDaily_box">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: center">
                    <span style="font-size: 25px;font-weight: bold">Store Operations Daily Report</span>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <span style="float: left">Business Date：<span id="bsDate">${bsDate?string('dd/MM/yyyy')}</span></span>
                    <input type="hidden" id="businessDate" value="${bsDate?string('yyyyMMdd')}" >
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <span style="float: left" id="storeName">Store：</span>
                    <span style="float: right" id="printDate">Print Date：${printTime}</span>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <table class="table table-hover table-striped table-condensed table-bordered zgrid-table" style="margin-bottom: 10px">
                        <tr>
                            ...
                            <th>Count Customer</th>[#--顾客统计--]
                            <th>PSD</th>[#--过去28天平均销售金额--]
                        </tr>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-1-5 col-lg-1-5">
                    <table class="table table-hover table-striped table-condensed table-bordered zgrid-table td-align" style="margin-bottom: 10px">
                        <tr>
                            [#--小标题--]
                            <th colspan="4" style="color: white">MERCHANDISE Mode of Payment – Breakdown</th>
                        </tr>
                        <tr>
                            [#--支付方式--]
                            <th colspan="1">Payment<br>Type</th>
                            <th colspan="1">Amount<br>(VND)</th>
                            <th colspan="1">Contribution<br>%</th>
                            <th colspan="1">Customer<br>Count</th>
                        </tr>
                        <tr>
                            [#--现金 Cash--]
                            <td id="payCd0"></td>
                            <td id="payAmt0">0</td>
                            <td id="Contribution0" style="text-align: right">0</td>
                            <td id="customerCount0">0</td>
                        </tr>
                        <tr>
                            [#--苏宁卡 Card Payment--]
                            <td id="payCd1"></td>
                            <td id="payAmt1">0</td>
                            <td id="Contribution1" style="text-align: right">0</td>
                            <td id="customerCount1">0</td>
                        </tr>
                        <tr>
                            [#--银联 E-Voucher--]
                            <td id="payCd2"></td>
                            <td id="payAmt2">0</td>
                            <td id="Contribution2" style="text-align: right">0</td>
                            <td id="customerCount2">0</td>
                        </tr>
                        <tr>
                            [#--商品券 Momo--]
                            <td id="payCd3"></td>
                            <td id="payAmt3">0</td>
                            <td id="Contribution3" style="text-align: right">0</td>
                            <td id="customerCount3">0</td>
                        </tr>
                        <tr>
                            [#--打折券 Zalo--]
                            <td id="payCd4"></td>
                            <td id="payAmt4">0</td>
                            <td id="Contribution4" style="text-align: right">0</td>
                            <td id="customerCount4">0</td>
                        </tr>
                        <tr>
                            [#--预付卡 VNPAY--]
                            <td id="payCd5"></td>
                            <td id="payAmt5">0</td>
                            <td id="Contribution5" style="text-align: right">0</td>
                            <td id="customerCount5">0</td>
                        </tr>
                        <tr>
                            [#--GrabMoca--]
                            <td id="payCd6"></td>
                        ...
                        <tr style="background-color: #00B2EE">
                            <td>Total</td>
                            <td id="payAmt">0</td>
                            <td id="Contribution" style="text-align: right">0 %</td>
                ...
                <div class="col-xs-12 col-sm-12 col-md-1-5 col-md-offset-1-5 col-lg-1-5 col-lg-offset-1-5">
                    <table class="table table-hover table-striped table-condensed table-bordered zgrid-table td-align" style="margin-bottom: 10px">
                        ...
                        <tr>
                            <td>Bank Deposit</td>[#--银行缴款--]
								<td id="bankDepositAmount">0</td>
							</tr>
                        <tr>
            ...
            [#--<div class="row">
				...
				<div class="wire"></div>--]
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-1-5 col-lg-1-7">
                    <table class="table table-hover table-striped table-condensed table-bordered zgrid-table td-align" style="margin-bottom: 10px">
                        <tr>
                            <th colspan="4" style="color: white">Services Revenue – Breakdown (Cash Only)</th>
                        </tr>
                        <tr>
                            <th colspan="1">Service Type</th>
                            <th colspan="1">Amount (VND)</th>
                            <th colspan="1">Contribution %</th>
                            <th colspan="1">Customer Count</th>
                        </tr>
                        <tr>
                            <td id="payoo">Payoo</td>
                            <td id="servicePayAmt0">0</td>
                            <td id="serviceContribution0" style="text-align: right">0</td>
                            <td id="customerService0">0</td>
                        </tr>
                        <tr>
                            <td id="PayBill" style="text-align: center">PayBill</td>
                            <td id="servicePayAmtPayBill" style="text-align: center">0</td>
                            <td id="serviceContributionPayBill" style="text-align: center">0</td>
                            <td id="customerServicePayBill" style="text-align: center">0</td>
                        </tr>
                        <tr>
                            <td id="PayCode" style="text-align: center">PayCode</td>
                            <td id="servicePayAmtPayCode" style="text-align: center">0</td>
                            <td id="serviceContributionPayCode" style="text-align: center">0</td>
                            <td id="customerServicePayCode" style="text-align: center">0</td>
                        </tr>
                        <tr>
                            <td id="momo_cash_in">Momo Cash-In</td>
                            <td id="servicePayAmt1">0</td>
                            <td id="serviceContribution1" style="text-align: right">0</td>
                            <td id="customerService1">0</td>
                        </tr>
                        <tr>
                            <td id="viettel">Viettel Phonecard via POS</td>
                            <td id="servicePayAmt2">0</td>
                            <td id="serviceContribution2" style="text-align: right">0</td>
                            <td id="customerService2">0</td>
                        </tr>
                        <tr style="background-color: #00B2EE">
                            <td>Total</td>
                            <td id="servicePayAmt">0</td>
                            <td id="serviceContribution" style="text-align: right">0 %</td>
                            <td id="customerService">0</td>
                        </tr>
                    </table>
                </div>
            </div>
