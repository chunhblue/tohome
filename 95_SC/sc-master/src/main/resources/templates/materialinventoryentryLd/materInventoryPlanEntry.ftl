...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.materialPlanEntry'/]"></script>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label for="pd_start_date"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label not-null" style="white-space: nowrap">Date Created</label>
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
...
[#--                                    </div>--]
                                    <label for=""  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label" style="white-space: nowrap">Document No.</label>
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
...
[@permission code="SC-MATEL-ENTRY-001"]<input type="hidden" class="permission-verify" id="addBut" value="${displayVar!}" />[/@permission]
[@permission code="SC-MATEL-ENTRY-002"]<input type="hidden" class="permission-verify" id="editBut" value="${displayVar!}" />[/@permission]
[@permission code="SC-MATEL-ENTRY-003"]<input type="hidden" class="permission-verify" id="viewBut" value="${displayVar!}" />[/@permission]
[@permission code="SC-MATEL-ENTRY-004"]<input type="hidden" class="permission-verify" id="exportBut" value="${displayVar!}" />[/@permission]
[@permission code="SC-MATEL-ENTRY-005"]<input type="hidden" class="permission-verify" id="importBut" value="${displayVar!}" />[/@permission]
[@permission code="SC-MATEL-ENTRY-006"]<input type="hidden" class="permission-verify" id="printBut" value="${displayVar!}" />[/@permission]
</body>
</html>
