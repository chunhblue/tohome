...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.stockAdjustment'/]"></script>
...
[#--   </div>--]
	<!--导航-->
	[@common.nav "HOME&Inventory&Inventory Adjustment Entry"][/@common.nav]
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<div class="form-horizontal">
									...
									<div class="form-group">
									    ...
									    <label for="bf_start_date"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label not-null" style="white-space: nowrap">Document Date</label>
									    <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
										...
										<label for="bf_end_date"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label not-null"></label>
									    <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
...
[@permission code="SC-ST-ADJUST-001"]<input type="hidden" class="permission-verify" id="addButPm" value="${displayVar!}" />[/@permission]
[@permission code="SC-ST-ADJUST-002"]<input type="hidden" class="permission-verify" id="viewButPm" value="${displayVar!}" />[/@permission]
[@permission code="SC-ST-ADJUST-003"]<input type="hidden" class="permission-verify" id="editButPm" value="${displayVar!}" />[/@permission]
[@permission code="SC-ST-ADJUST-005"]<input type="hidden" class="permission-verify" id="approvalrecordButPm" value="${displayVar!}" />[/@permission]
</body>
</html>
