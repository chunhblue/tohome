...
<head>
	...
	<script src="${m.staticpath}/[@spring.message 'js.stockAdjustmentEdit'/]"></script>
...
[#--	</div>--]
<!--导航-->
[@common.nav "HOME&Inventory&Item Adjustment Detail"][/@common.nav]
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="form-horizontal">
								<div class="form-group">
									...
									<label for="tf_date"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label" style="white-space: nowrap">Adjustment Date</label>
									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
										<input id="tf_date" readonly="true" placeholder="Adjustment Date" class="form-control input-sm" type="text" value="">
									</div>
									...
									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
										<select id="dj_type" disabled="disabled" class="form-control input-sm">
											...
											<option value="604" selected="selected">Inventory Adjustment</option>
										</select>
									</div>
									<label for="dj_status"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label" style="white-space: nowrap" hidden>Document Status</label>
									...
									<label for="vstore"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label not-null">Store No.</label>
									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
								...
								<div class="form-group">
									<label for="adjustmentSum"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Amount</label>
									<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2">
										<input type="text" id="adjustmentSum" readonly="true" class="form-control input-sm">
									</div>
								...
								<div class="form-group">
									...
									[#--<label for="ap_name"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Approve Staff</label>
									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
										<input type="text" readonly="true" id="ap_name" class="form-control input-sm">
									</div>
									<label for="ap_date"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Approve Date</label>
									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Item Adjustment Detail</h4>
			</div>
					...
					<div class="form-horizontal" >
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="form-group">
								...
								[#--实时库存--]
								<label for="inventoryQty"  class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label">Inventory Qty</label>
								<div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
							...
							<div class="form-group">
								...
								<label for="adjustReason"  class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label not-null" style="white-space: nowrap">Adjustment Reason</label>
								<div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
									<div class="aotu-pos good-select">
							...
							<div class="form-group" id="expenditureDescription">
								<label for="description" class="col-xs-12 col-sm-4 col-md-3 col-lg-2 control-label" style="white-space: nowrap">Expenditure Description</label>
...
<input type="hidden" id="adjusthidek" value="">
</body>
</html>
