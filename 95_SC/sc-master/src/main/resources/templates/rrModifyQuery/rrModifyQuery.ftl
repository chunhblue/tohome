...
<head>
	...
	<script src="${m.staticpath}/[@spring.message 'js.rrModifyQuery'/]"></script>
...
[#--	</div>--]
	<!--导航-->
[@common.nav "HOME&Receiving&Receiving And Return Document Correction Query"][/@common.nav]
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label for="md_voucher_no"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Modification Document No.</label>
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                        <input type="text" id="md_voucher_no" class="form-control input-sm">
                                    </div>
                                    <label for="or_voucher_no"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Original Document No.</label>
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                        <input type="text" id="or_voucher_no" class="form-control input-sm">
                                    </div>
									<label for="modificationType"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Modification Type</label>
									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                ...
                                <div class="form-group">
                                    <label for="xz_start_date" class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label not-null" style="white-space: nowrap">Modification Date</label>
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                        <input id="xz_start_date"  placeholder="Start Date" class="form-control input-sm select-date" type="text" value="">
                                    </div>
                                    <label for="xz_end_date" class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label not-null"></label>
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                        <input  id="xz_end_date"  placeholder="End Date" class="form-control input-sm select-date" type="text" value="">
                                    </div>
...
[@permission code="SC-RR-MODIF-001"]<input type="hidden" class="permission-verify" id="viewBut" value="${displayVar!}" />[/@permission]
[@permission code="SC-RR-MODIF-002"]<input type="hidden" class="permission-verify" id="editBut" value="${displayVar!}" />[/@permission]
[@permission code="SC-RR-MODIF-004"]<input type="hidden" class="permission-verify" id="exportBut" value="${displayVar!}" />[/@permission]
[@permission code="SC-RR-MODIF-005"]<input type="hidden" class="permission-verify" id="approvalBut" value="${displayVar!}" />[/@permission]
</body>
</html>
