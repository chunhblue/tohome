...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.auditRejected'/]"></script>
...
<body>
<!--导航-->
[@common.nav "HOME&Message&Rejected Approvals"][/@common.nav]
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <label for="userName"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Created By</label>[#--发起人姓名--]
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                        <div class="aotu-pos">
...
[@permission code="SC-INF-REJECTED-001"]<input type="hidden" class="permission-verify" id="rejectedButView" value="${displayVar!}" />[/@permission]
</body>
</html>