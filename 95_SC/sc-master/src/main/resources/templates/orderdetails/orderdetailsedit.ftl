						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
										<input type="text" id="order_id" class="form-control input-sm" value="${orderId!}" readonly="readonly">
									</div>
								...
								<div class="form-group">
									...
									<label for="a_vendor"  class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Supplier</label>
									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
										<div class="aotu-pos">
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2" hidden>
										<input type="hidden" id="order_total_amt" placeholder="Total Amount" readonly="readonly">
									</div>
								</div>
			...
			<div class="modal-body">
				<div class="row">
					<div class="form-horizontal" >
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="form-group">
								<label for="a_item"  class="col-xs-12 col-sm-2 col-md-2 col-lg-3 control-label not-null">Item</label>
...
[#--								</div>--]
							...
							<div class="form-group">
								...
								<label for="item_input_orderNochargeQty"  class="col-xs-12 col-sm-2 col-md-2 col-lg-3 control-label" hidden="true"><span style="color:red;">*</span>Free Qty</label>
								<div class="col-xs-12 col-sm-4 col-md-3 col-lg-3" hidden="true">
			...
			<div class="modal-footer">
				...
				<input type="hidden" id="item_input_cd" value="" />
