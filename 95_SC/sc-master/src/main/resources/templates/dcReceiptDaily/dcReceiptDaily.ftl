...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.dcReceiptDaily'/]"></script>
...
[#--	</div>--]
<!--导航-->
[@common.nav "HOME&Report&Store Receiving Daily Report(To DC)"][/@common.nav]
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">DC</label>
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
