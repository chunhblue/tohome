...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.hhreportSummy'/]"></script>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <label for="aRegion" class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Region</label>
                                    ...
                                    <label for="aCity" class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">City</label>
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                        <div class="aotu-pos">
                                    ...
                                    <label for="aDistrict" class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">District</label>
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                        <div class="aotu-pos">
                                    ...
                                    <label for="aStore" class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">Store</label>
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                        <div class="aotu-pos">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <table id="dailyTable" class="table table-hover table-striped table-condensed table-bordered zgrid-table"
                        ...
                        <tr>
                            ...
                            <th title=">Total Open PO">Total Open PO</th>
                            <th title="Qty Of GRPO">Qty Of GRPO</th>
                            <th title="No Of Confirmed Po">No Of Confirmed PO</th>
                            <th title="No Of Pending GRPO">No Of Pending GRPO</th>
                        </tr>
                    </table>
