...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.stampDetailReport'/]"></script>
    <STYLE>
...
<!--导航-->
[@common.nav "HOME&Report&Stamp Detail Report At Store Level"][/@common.nav]
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 [#--col-lg-offset-1--] businessDaily_box">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: center">
                <span style="font-size: 25px;font-weight: bold">Stamp Detail Report At Store Level</span>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <table id="dailyTable" class="table table-hover table-striped table-condensed table-bordered zgrid-table"
                    ...
                    <tr>
                        <th title="Store Code">Store Code</th>
                        ...
                        <th title="Total Issued Qty">Total Issued Qty</th>
                        <th title="Qty by Bonus Items">Qty by Bonus Items</th>
                        <th title="Qty by Amount">Qty by Amount</th>
                    </tr>
                </table>
