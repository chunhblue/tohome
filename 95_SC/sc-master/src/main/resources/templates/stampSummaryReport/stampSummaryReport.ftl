...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.stampSummaryReport'/]"></script>
    <STYLE>
...
<!--导航-->
[@common.nav "HOME&Report&Stamp Summary Report At Store Level"][/@common.nav]
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 [#--col-lg-offset-1--] businessDaily_box">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: center">
                <span style="font-size: 25px;font-weight: bold">Stamp Summary Report At Store Level</span>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
