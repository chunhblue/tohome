...
<head>
    ...
    <script src="${m.staticpath}/[@spring.message 'js.serviceTypeDaily'/]"></script>
    <STYLE>
...
<!--导航-->
[@common.nav "HOME&Report&Service Type Daily Report"][/@common.nav]
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 [#--col-lg-offset-1--] businessDaily_box">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: center">
                <span style="font-size: 25px;font-weight: bold">Service Type Daily Report</span>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <table id="dailyTable" class="table table-hover table-striped table-condensed table-bordered zgrid-table"
                    ...
                    <tr>
                        ...
                        <th title="Merchandising">Merchandising</th>
                        <th title="Food Service">Food Service</th>
