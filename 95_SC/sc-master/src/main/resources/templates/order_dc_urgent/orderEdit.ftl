						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
									<div class="aotu-pos">
										<input type="text" class="form-control my-automatic input-sm" id="a_item" placeholder="" autocomplete="off" title="" onmouseover="this.title=this.value"  data-toggle="tooltip" data-trigger="hover">
...
[#--								</div>--]
			...
			<div class="modal-footer">
				...
				<input type="hidden" id="taxRateName">
