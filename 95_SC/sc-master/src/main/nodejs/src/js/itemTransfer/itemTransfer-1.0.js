...
define('itemTransfer', function () {
    ...
    var table_event = function(){
        ...
        $("#updateStoreDetails").on("click", function (e) {
            ...
            if(selectTrTemp==null){
                ...
                var cols = tableGrid.getSelectColValue(selectTrTemp,"storeCd,storeCd1,voucherDate,voucherNo,voucherType");
                //获取数据审核状态
                _common.getRecordStatus(cols["voucherNo"],m.typeId.val(),function (result) {
                    if(result.success){
                        ...
                        var param = "storeCd=" + cols["storeCd"] +"&storeCd1=" + cols["storeCd1"] +
                            "&voucherDate=" + voucherDate + "&voucherNo=" + cols["voucherNo"]+"&voucherType=" + cols["voucherType"]
                            + "&flag=edit";
                        saveParamToSession();
        ...
        $("#viewStoreDetails").on("click", function (e) {
            if(selectTrTemp==null){
                ...
                var param = "storeCd=" + cols["storeCd"] +"&storeCd1=" + cols["storeCd1"] +
                    "&voucherDate=" + voucherDate + "&voucherNo=" + cols["voucherNo"]
                    +"&voucherType=" + cols["voucherType"]+ "&flag=view";
                saveParamToSession();
    ...
    var initTable1 = function(){
        tableGrid = $("#zgGridTtable").zgGrid({
            ...
            param:paramGrid,
            localSort: true,
            colNames:["Store No.","Store Name","Transfer Date","Document No.","Store No.1",
...
var _index = require('itemTransfer');
