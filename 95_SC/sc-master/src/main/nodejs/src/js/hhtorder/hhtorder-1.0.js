...
define('orderHHT', function () {
    ...
    var but_event = function(){
        ...
        $('input:radio[name="query_type"]').on('change',function(){
            ...
            if(checkValue==='1'){
                $("#query_type_val").attr("disabled",true);
            }else {
                $("#query_type_val").attr("disabled",false);
            }
        });
    }
    ...
    var initTable1 = function(){
        tableGrid = $("#zgGridTtable").zgGrid({
            ...
            param:paramGrid,
            localSort: true,
            colNames:["Store Cd","Store Name","Order Date","Barcode","Item Code","Item Name","Qty", "Vendor Code","Vendor Name","Update Time"],
            colModel:[
                ...
                {name:"ordDate",type:"text",text:"center",width:"130",ishide:false,css:"",getCustomValue:dateFmt},
                ...
                {name:"qty",type:"text",text:"right",width:"130",ishide:false,css:"",getCustomValue:getThousands},
                /*商品进货单价和税后订货总金额*/
                ...
                {name:"uploadTime",type:"text",text:"left",width:"150",ishide:false,css:"",getCustomValue:dateFmtHms}
            ],//列内容
            width:"max",//宽度自动
            page:1,//当前页
            rowPerPage:10,//每页数据量
    ...
    var dateFmtHms = function(tdObj, value){
        if(value!=null&&value.trim()!=''&&value.length==14) {
            value = fmtStringIntDate(value);
        }
        return $(tdObj).text(value);
    }
    var fmtStringIntDate=function (date) {
