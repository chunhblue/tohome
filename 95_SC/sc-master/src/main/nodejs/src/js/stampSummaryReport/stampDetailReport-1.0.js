...
define('stampDetailReport', function () {
    var self = {};
    var url_left = "",
        systemPath = "",
        reThousands = null,
    ...
    function init(_common) {
        createJqueryObj();
        url_left = _common.config.surl + "/stampDetailReport";
                ...
                if (result.success) {
                    ...
                    for (let i = 0; i < dataList.length; i++) {
                        ...
                        let tempTrHtml =
                            ...
                            '<td title="'+_common.formatCreateDate(item.createYmdHms)+'" style="text-align: left">'+_common.formatCreateDate(item.createYmdHms)+'</td>' +
                            '<td title="'+toThousands(item.totalIssuedQty)+'" style="text-align: right">'+toThousands(item.totalIssuedQty)+'</td>' +
                            '<td title="'+toThousands(item.bonusItemsQty)+'" style="text-align: right">'+toThousands(item.bonusItemsQty)+'</td>' +
                            '<td title="'+toThousands(item.amountQty)+'" style="text-align: right">'+toThousands(item.amountQty)+'</td>' +
                            '</tr>';
...
var _index = require('stampDetailReport');
