...
define('ReturnedDailyWarehouse', function () {
    var self = {};
    var url_left = "",
        systemPath = "",
        reThousands = null,
    ...
    var setParamJson = function () {
        ...
        let deliveryCenterId = $("#delivery_center_id").attr('k');
    ...
    function init(_common) {
        createJqueryObj();
        url_left = _common.config.surl + "/dcReturnedDaily";
                ...
                if (result.success) {
                    ...
                    for (let i = 0; i < dataList.length; i++) {
                        ...
                        let tempTrHtml = '<tr>' +
                            ...
                            '<td title="' + isEmpty(item.deliveryCenterId) + '" style="text-align:right;">' + isEmpty(item.deliveryCenterId) + '</td>' +
                            '<td title="' + isEmpty(item.deliveryCenterName) + '" style="text-align:left;">' + isEmpty(item.deliveryCenterName) + '</td>' +
...
var _index = require('ReturnedDailyWarehouse');
