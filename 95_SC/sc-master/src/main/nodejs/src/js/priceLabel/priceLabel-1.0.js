...
define('priceLabel', function () {
    ...
    var but_event = function () {
        ...
        $("#print").on("click",function () {
            ...
            // var url = url_left +"/print?"+ paramGrid+"&flg=print&params="+params;
        ...
        $("#preview").on("click",function () {
            ...
            paramGrid = "searchJson="+m.searchJson.val();
                ...
                let params=JSON.stringify(_params)
            // var url = url_left +"/print?"+ paramGrid+"&flg=preview"+"&params="+params;
    ...
    var initTable1 = function () {
        tableGrid = $("#zgGridTtable").zgGrid({
            ...
            colModel: [
                ...
                {name: "oldPrice", type: "text", text: "right", width: "130", ishide: false,getCustomValue: getThousands},
                {name: "newPrice", type: "text", text: "right", width: "130", ishide: false,getCustomValue: getThousands},
                {name: "effectiveStartDate", type: "text", text: "center", width: "130", ishide: false,getCustomValue: dateFmt},
            ],//列内容
            width: "max",//宽度自动
            page: 1,//当前页
            rowPerPage: 10,//每页数据量
