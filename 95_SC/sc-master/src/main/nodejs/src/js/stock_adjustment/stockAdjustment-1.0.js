...
define('stockAdjustment', function () {
	...
	var initParam = function () {
		...
		m.bf_start_date.val(obj.voucherStartDate);
		m.bf_end_date.val(obj.voucherEndDate);
    ...
    var setParamJson = function(){
        // 日期格式转换
        var _startDate = fmtStringDate(m.bf_start_date.val())||null;
        var _endDate = fmtStringDate(m.bf_end_date.val())||null;
        ...
        var searchJsonStr ={
			...
			sourceVoucherNo:m.sourceVoucherNo.val(),
            voucherStartDate:_startDate,
            voucherEndDate:_endDate,
            itemInfo:m.itemInfo.val(),
    ...
    var but_event = function(){
    	// 清空日期
    	m.clear_bf_date.on("click",function(){
    		m.bf_start_date.val("");
    		m.bf_end_date.val("");
    	});
      // 重置按钮
    ...
    var initTable1 = function(){
		tableGrid = $("#zgGridTtable").zgGrid({
    		...
    		param:paramGrid,
			localSort: true,
			colNames:["Document Date","Document No.","Source Document No.","Store No.","Store Name","Store No.","Document Type",
				"Document Type","Status","Remarks","Sales Amount","Date Created","Created By"],
    		colModel:[
				{name:"voucherDate",type:"text",text:"center",width:"130",ishide:false,css:"",getCustomValue:dateFmt},
				{name:"voucherNo",type:"text",text:"right",width:"120",ishide:false,css:""},
				{name:"voucherNo1",type:"text",text:"right",width:"140",ishide:true,css:""},
				...
				{name:"createYmd",type:"text",text:"right",width:"120",ishide:false,getCustomValue:_common.formatDateAndTime},
