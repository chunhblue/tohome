...
define('suspendSaleDetail', function () {
    var self = {};
    var url_left = "",
		systemPath = "",
	    paramGrid = null,
 ...
 // 创建js对象
    ...
    function init(_common) {
    	createJqueryObj();
    	url_left =_common.config.surl+"/suspendSaleDetail";
    	...
    	m.search.on("click",function(){
    		if(verifySearch()){
				...
				paramGrid = "createUserId="+m.createUserId.val().trim()+
					...
					"&districtCd="+districtCd+
					"&storeCd="+storeCd+
					"&startChangeId="+m.startChangeId.val()+
					"&endChangeId="+m.endChangeId.val();
				tableGrid.setting("url",url_left+"/getSuspendSaleDetail");
    ...
    var initTable1 = function(){
		tableGrid = $("#zgGridTtable").zgGrid({
    		title:"Details",
    		param:paramGrid,
    		colNames:["Business Date","Document No.","Store No.","Store Name","Barcode","Item Code","Item Name","Spec","UOM","Suspend Sales Date","Created  By","User Id"],
    		colModel:[
				...
				{name:"createUserId",type:"text",text:"center",width:"130",ishide:true,css:""}
			],//列内容
			width:"max",//宽度自动
			page:1,//当前页
			rowPerPage:10,//每页数据量
...
var _index = require('suspendSaleDetail');
