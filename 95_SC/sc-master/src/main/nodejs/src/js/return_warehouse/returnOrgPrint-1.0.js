...
define('returnWarehouseOrgPrint', function () {
    var self = {};
    var url_left = "",
        systemPath='';
    var m = {
                ...
                if(result.success){
                    ...
                    for (let i = 0; i < dataList.length; i++) {
                        ...
                        let tempTrHtml = '<tr style="text-align: center;">' +
                            ...
                            // '<td  id="orgNotext" style="text-align: right">'+isEmpty(item.orgOrderId)+'</td>' +
                            '<td style="text-align: right">'+isEmpty(item.deliveryCenterId)+'</td>' +
...
var _index = require('returnWarehouseOrgPrint');
