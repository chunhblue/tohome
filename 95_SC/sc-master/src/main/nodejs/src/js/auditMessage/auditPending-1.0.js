...
define('auditPending', function () {
    ...
    var but_event = function(){
        ...
        m.search.on("click",function(){
            if(verifySearch()) {
                ...
                tableGrid.setting("url", url_left + "/getPendingApprovals");
    ...
    var approval_event = function () {
        ...
        $("#approvalBut").on("click",function(){
            ...
            var cols = tableGrid.getSelectColValue(selectTrTemp,"recordCd,typeId");
            var recordCd = cols["recordCd"];
            var typeId = cols["typeId"];
            if(recordCd!=null&&recordCd!=""&&typeId!=null&&typeId!=""){
                $("#approval_dialog").modal("show");
                //获取审核记录
                _common.getStep(recordCd,typeId);
            }else{
    ...
    var initTable = function(){
        tableGrid = $("#zgGridTtable").zgGrid({
            ...
            colModel:[
                ...
                {name:"url",type:"text",text:"left",width:"150",ishide:true,css:""},
                {name:"typeName",type:"text",text:"left",width:"100",ishide:false,css:"",getCustomValue:urlFmt},
                {name:"status",type:"text",text:"left",width:"100",ishide:true,css:""},
                ...
                {name:"createUserName",type:"text",text:"left",width:"100",ishide:false,css:""},
    ...
    var isButPermission = function () {
        var auditBut = $("#auditBut").val();
        if (Number(auditBut) != 1) {
            $("#approvalBut").remove();
        }
...
var _index = require('auditPending');
