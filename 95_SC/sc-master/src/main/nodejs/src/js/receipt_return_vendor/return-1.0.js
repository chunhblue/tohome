...
define('receiptReturnVendor', function () {
    var self = {};
    var url_left = "",
        paramGrid = null,
    ...
    var verifySearch = function () {
        ...
        if(_StartDate>_EndDate){
            ...
            var vendorName = m.vendor_name.val().length;
            if (vendorName>10){
                _common.prompt("Input supplier name not more than 10  !",3,"info");
                $("#vendor_name").focus();
                return false;
            }
...
var _index = require('receiptReturnVendor');
