 ...
 */
@Slf4j
public class DayOrderFailureExHeaderListener implements ExEventListener {
    OrderFailedParamDTO param;

    public DayOrderFailureExHeaderListener(OrderFailedParamDTO param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Failed Order Of The Day Query List";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Order Date,Order By,Order Type,Store No.,Store Name,Vendor Code," +
                "Vendor Name,Order Quantity,Vender MOQ,Order Gap Quantity,Order Gap Amount";
