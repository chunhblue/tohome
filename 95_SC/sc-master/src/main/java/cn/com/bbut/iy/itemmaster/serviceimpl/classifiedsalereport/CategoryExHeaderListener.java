 ...
 */
@Slf4j
public class CategoryExHeaderListener implements ExEventListener {

    clssifiedSaleParamReportDTO param;

    public CategoryExHeaderListener(clssifiedSaleParamReportDTO param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Department Sales Daily Report";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO,Store No.,Store Name,Top Department,Department,Category,Sub-Category,Sales Quantity,Sales Amount,Sales Date,Area Manager ID,Area Manager Name";
