 ...
 */
@Slf4j
public class ItemTransferDailyExHeaderListener implements ExEventListener {
    VendorReceiptDailyParamDTO param;

    public ItemTransferDailyExHeaderListener(VendorReceiptDailyParamDTO param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Item Transfer Daily Report";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Store No.,Store Name,Date,Out Item Code,Out Item Name,Out Barcode,In Item Code,In Item Name," +
                "In Barcode,Transfer Quantity,Transfer Reason,Area Manager Name";
