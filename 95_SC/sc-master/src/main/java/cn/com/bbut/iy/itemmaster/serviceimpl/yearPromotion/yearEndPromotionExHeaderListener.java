...
/**
 * @ClassName yearEndPromotionExHeaderListener
 * @Description TODO
 * @Author Ldd
 * @Date 2021/3/3 10:41
 * @Version 1.0
...
public class yearEndPromotionExHeaderListener implements ExEventListener {
    yearEndPromotionParamDto dto;


    public yearEndPromotionExHeaderListener( yearEndPromotionParamDto dto){this.dto=dto;};

    @Override
    public void action(Workbook wb) {
        Sheet sheet = wb.getSheet(Constants.EXCEL_SHEET_DEF_NAME);
        // 大标题
        String row0 = "Year End Promotion Redemption Detail By Store HCM";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "No,Date,Pincode,ConfirmationNumber,Item Code,Item Name,Quantity,Date Time";
