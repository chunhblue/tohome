 ...
 */
@Slf4j
public class DiffExHeaderListener implements ExEventListener {

    DifferenceListParam param;

    public DiffExHeaderListener(DifferenceListParam param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Delivery Difference Adjustment Query List";
        ...
        String row2 = "";
        // 列标题
        if ("0".equals(param.getOrderDifferentiate())) {
            row2 = "NO.,PO No.,Date Ordered,Last Date Received,Last Received No.," +
                    "Store No,Store Name,Vendor Code,Vendor Name,Total Variance Quantity,Document Date";
        } else {
            row2 = "NO.,PO No.,Date Ordered,Last Date Received,Last Received No.," +
                    "Store No,Store Name,DC No.,DC Name,Total Variance Quantity,Document Date";
        }
