 ...
 */
@Slf4j
public class RRQueryExHeaderListener implements ExEventListener {

    RRVoucherParamDTO param;

    public RRQueryExHeaderListener(RRVoucherParamDTO param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Receiving And Return Query";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Document Date,Document No.,Original Document No.,Document Type,Store Code,Store Name,Area Manager Name,Operation Manager Name,Operation Controller Name,Vendor Code," +
                "Vendor Name,Order Method,Vat In(%),Document Status";
