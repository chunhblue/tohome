 ...
 */
@Slf4j
public class GoodSaleExHeaderListener implements ExEventListener {

    goodSaleReportParamDTO param;

    public GoodSaleExHeaderListener(goodSaleReportParamDTO param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Item Sales Daily Report";
