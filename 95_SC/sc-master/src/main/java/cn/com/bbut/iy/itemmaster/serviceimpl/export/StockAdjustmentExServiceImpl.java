 ...
 */
@Slf4j
@Service(value = "stockAdjustmentExService")
public class StockAdjustmentExServiceImpl implements ExService {
    ...
    public File getExcel(BaseExcelParam param) throws IOException {
        ...
        // 生成文件标题信息对象
        session.setHeaderListener(new StockAdjustmentExHeaderListener(jsonParam));
