 ...
 */
@Slf4j
public class InventoryReportExHeaderListener implements ExEventListener {

    VendorReceiptDailyParamDTO param;

    public InventoryReportExHeaderListener(VendorReceiptDailyParamDTO param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Store Inventory Daily Report";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Store No.,Store Name,Document Date,Top Department,Department,Category,Sub-Category,Barcode,Item Code,Item Name,UOM,Area Manager Name,Quantity";
