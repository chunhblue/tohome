 ...
 */
@Slf4j
public class InvoiceEntryExHeaderListener implements ExEventListener {

    InvoiceEntryDTO param;

    public InvoiceEntryExHeaderListener(InvoiceEntryDTO param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Invoice Query List";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Store No.,Store Name,Date and Time,Receipt No.,Amount,Customer's Name,Company's Name," +
                "TAX CODE,Address (which register with the Tax government),Telephone Number,E-mail,Status";
