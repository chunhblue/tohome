 ...
 */
@Slf4j
@Service(value = "rawStockExService")
public class MaterialExServiceImpl implements ExService {
    ...
    public File getExcel(BaseExcelParam param) throws IOException {
        ...
        // 生成文件标题信息对象
        session.setHeaderListener(new MaterialExHeaderListener(jsonParam));
    ...
    private void createExcelBody(Sheet sheet, int curRow, PI0100ParamDTOC jsonParam) {
        // 查询数据
        List<PI0100DTOC> _list = materialplanMapper.search(jsonParam);
