 ...
 */
@Slf4j
public class DCReceiptDailyExHeaderListener implements ExEventListener {

    VendorReceiptDailyParamDTO param;

    public DCReceiptDailyExHeaderListener(VendorReceiptDailyParamDTO param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Store Receiving Daily Report(To DC)";
        ...
        String row2 = "NO.,Document No.,Store No.,Store Name,Submission Date,Department,Category,Sub-category,Item Code,Item Name," +
                "Barcode,DC,Area Manager ID,Operation Manager ID,Receiving Quantity,Created By,Remark";
