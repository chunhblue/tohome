...
/**
 * @ClassName RtVendorOrgExHeaderListener
 * @Description TODO
 * @Author Administrator
 * @Date 2020/8/18 21:01
 * @Version 1.0
 */

public class RtVendorOrgExHeaderListener  implements ExEventListener {
    RVListParam param;

    public RtVendorOrgExHeaderListener(RVListParam param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Item Return Request List(To Supplier)";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Date Returned,Document No.,Supplier No.,Supplier Name," +
                "Store Name,Document Status,Return Qty,Return Type";
