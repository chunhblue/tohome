 ...
 */
@Slf4j
public class SuspendSaleExHeaderListener implements ExEventListener {

    PriceDetailParamDto param;

    public SuspendSaleExHeaderListener(PriceDetailParamDto param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Suspend Sales List";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Business Date,Document No,Store No.,Store Name,Barcode,Item Code,Item Name,Spec,UOM," +
                "Suspend Sales Date,Created By";
