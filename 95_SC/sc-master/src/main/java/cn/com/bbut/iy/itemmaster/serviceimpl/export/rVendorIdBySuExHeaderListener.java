...
/**
 * @ClassName rVendorIdBySuExHeaderListener
 * @Description TODO
 * @Author Ldd
...
public class rVendorIdBySuExHeaderListener implements ExEventListener {
    RVListParam param;

    public rVendorIdBySuExHeaderListener(RVListParam param) {
        this.param = param;
    }
