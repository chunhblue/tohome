 ...
 */
@Slf4j
public class RealtimeExHeaderListener implements ExEventListener {

    RTInventoryQueryParamDTO param;

    public RealtimeExHeaderListener(RTInventoryQueryParamDTO param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Real-time Inventory Query List";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Item Barcode,Item Code,Item Name,Specification,UOM,Department,Category,Sub Category,Vendor Code,Vendor Name," +
                "Real Time Stock Quantity,Inventory Quantity(Previous Day),Sales Quantity the day,Receiving Quantity the day," +
                "Return Quantity the day,Inventory Adjustment Quantity the day,Stock on Order Quantity," +
                "Write-off Quantity the day,Transfer In Quantity,Transfer Out Quantity,Area Manager Code,Area Manager Name,Operation Controller Code,Operation Controller Name,Operation Manager Code,Operation Manager Name";
