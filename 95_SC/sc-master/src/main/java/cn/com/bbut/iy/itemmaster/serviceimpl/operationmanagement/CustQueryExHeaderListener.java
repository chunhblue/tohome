 ...
 */
@Slf4j
public class CustQueryExHeaderListener implements ExEventListener {

    PI0100ParamDTOC param;

    public CustQueryExHeaderListener(PI0100ParamDTOC param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Cost Item Adjustment List";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Store No.,Store Name,Document No.,Status,Remarks,Created By,Date Created";
