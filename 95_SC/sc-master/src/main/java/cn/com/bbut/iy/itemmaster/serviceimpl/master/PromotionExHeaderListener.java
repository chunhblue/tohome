...
/**
 * MM Promotion List Excel标题设置
 *
 */
@Slf4j
public class PromotionExHeaderListener implements ExEventListener {

    PromotionParamDTO param;

    public PromotionExHeaderListener(PromotionParamDTO param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "MM Promotion Query List";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Promotion No.,Promotion Theme,Promotion Start Date,Promotion End Date";
