...
/**
 * Store List Excel标题设置
 *
 */
@Slf4j
public class StoreExHeaderListener implements ExEventListener {

    StoreParamDTO param;

    public StoreExHeaderListener(StoreParamDTO param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Store Master Query List";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Store No.,Store Name,Effective Start Date,Effective End Date,Store Type,Area Manager,Price Tier," +
                "Store Cluster,Contract Type,Store Size-Group,Store Open Date,Store Close Date,Current Location";
