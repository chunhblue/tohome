...
/**
 * Article List Excel标题设置
 *
 */
@Slf4j
public class ArticleExHeaderListener implements ExEventListener {

    ArticleParamDTO param;

    public ArticleExHeaderListener(ArticleParamDTO param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 列标题
        String row2 = "NO.,Item Code,Item Name,Item English Name,Item Specification,Top Department,Department,Category," +
                "Sub-Category,Material Type,Product Status,Brand(Full)";
