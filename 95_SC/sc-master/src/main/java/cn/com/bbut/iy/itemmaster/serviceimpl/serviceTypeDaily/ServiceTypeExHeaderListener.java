 ...
 */
@Slf4j
public class ServiceTypeExHeaderListener implements ExEventListener {
    clssifiedSaleParamReportDTO param;

    public ServiceTypeExHeaderListener(clssifiedSaleParamReportDTO param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Service Type Daily Report";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO,Store No.,Store Name,Merchandising,Food Service,Service,Sales Date,Area Manager Name";
