...
/**
 * Vendor List Excel标题设置
 *
 */
@Slf4j
public class VendorExHeaderListener implements ExEventListener {

    VendorParamDTO param;

    public VendorExHeaderListener(VendorParamDTO param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Vendor Master Query List";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Vendor Code,Vendor Name,Business Type,Registered Address,Order Contact Name,Tel,Order Type";
