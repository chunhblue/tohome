 ...
 */
@Slf4j
public class ReturnsDailyExHeaderListener implements ExEventListener {

    ReturnsDailyParamDTO param;

    public ReturnsDailyExHeaderListener(ReturnsDailyParamDTO param) {
        this.param = param;
    }
