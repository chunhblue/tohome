...
/**
 * @ClassName postatusReportHeaderListener
 * @Description TODO
 * @Author Ldd
 * @Date 2021/6/8 13:47
 * @Version 1.0
...
public class postatusReportHeaderListener implements ExEventListener {
    hhtReportParamDto param;

    public postatusReportHeaderListener(hhtReportParamDto param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "PO Status Daily Report";

        // 二号标题
        String row1 = "";
        // 列标题
        String row2 = "NO.,Store No.,Store Name,Total Open PO,Qty Of GRPO,No Of Confirmed PO,No Of Pending GRPO";
