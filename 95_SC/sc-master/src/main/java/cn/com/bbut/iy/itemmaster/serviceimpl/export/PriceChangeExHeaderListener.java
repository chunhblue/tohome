 ...
 */
@Slf4j
public class PriceChangeExHeaderListener implements ExEventListener {

    PriceDetailParamDto param;

    public PriceChangeExHeaderListener(PriceDetailParamDto param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Urgent Price Info Update Query";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Business Date,Document No.,Store No.,Store Name,Barcode,Item Code,Item Name,Spec," +
                "Unit,Price Before Price Change,Selling Price After Price Change,Price Change Date,Created By";
