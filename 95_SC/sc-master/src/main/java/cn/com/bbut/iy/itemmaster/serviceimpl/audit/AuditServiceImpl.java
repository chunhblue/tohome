...
public class AuditServiceImpl implements IAuditService {
            ...
            if(status==10){
                ...
                */
                ...
                if((int)reviewId==ConstantsAudit.REVIEW_RECEIPT_WAREHOUSE
                    ...
                    OD0000 _dto = new OD0000();
                    //添加实际退货日期
                    _dto.setReceiveDate(date);
                    //设置退货状态为已收货
                    _dto.setOrderSts("04");
                    //设置为已退货确认
                    _dto.setReviewStatus(20);
                    OD0000Example example = new OD0000Example();
                    example.or().andOrderIdEqualTo(recordCd);
                    od0000Mapper.updateByExampleSelective(_dto,example);
                }
            }
    ...
    public int checkAuditByUserId(String storeCd, String userId, long position) {
        ...
        if(userId.equals("system")||userId.equals("demo001")||userId.equals("demo002")){
