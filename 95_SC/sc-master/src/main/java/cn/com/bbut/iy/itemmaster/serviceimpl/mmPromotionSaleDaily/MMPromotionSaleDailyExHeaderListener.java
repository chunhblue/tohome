 ...
 */
@Slf4j
public class MMPromotionSaleDailyExHeaderListener implements ExEventListener {

    MMPromotionSaleDailyParamDTO param;

    public MMPromotionSaleDailyExHeaderListener(MMPromotionSaleDailyParamDTO param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "MM Promotion Sales Daily Report";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Store No.,Store Name,Date,Promotion No.,Promotion Theme,Promotion Pattern,Promotion Type,Distribution Type," +
                "Selling Price,Sales Quantity,Sales Amount,Item Barcode,Item Code,Item Name,Selling Price,Sales Quantity,Sales Amount";
