 ...
 */
@Slf4j
public class RtReceiptVendorExHeaderListener implements ExEventListener {

    RVListParam param;

    public RtReceiptVendorExHeaderListener(RVListParam param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Item Return Entry(To Supplier)";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Date Returned,Document No.,Original Document No.,Supplier No.,Supplier Name," +
                "Store No.,Store Name,Document Status,Status,Return Qty,Actual Return Qty";
