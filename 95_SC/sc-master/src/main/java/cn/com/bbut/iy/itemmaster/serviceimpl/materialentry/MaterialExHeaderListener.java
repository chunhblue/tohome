 ...
 */
@Slf4j
public class MaterialExHeaderListener implements ExEventListener {

    PI0100ParamDTOC param;

    public MaterialExHeaderListener(PI0100ParamDTOC param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Raw Material Stock Query List";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Store No.,Store Name,Document No.,Remarks,Created by,Date Created";
