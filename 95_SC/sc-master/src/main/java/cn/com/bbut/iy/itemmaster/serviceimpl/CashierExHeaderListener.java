...
/**
 * @ClassName CashierExHeaderListener
 * @Description TODO
 ...
 */
@Slf4j
public class CashierExHeaderListener  implements ExEventListener {
    SA0050ParamDto param;


    public CashierExHeaderListener(SA0050ParamDto param){
        this.param= param;
    }
    ...
    public void action(Workbook wb) {
       ...
       // 大标题
        String row0 = "Cashier Managerment ";
        // 二号标题
        String row1 = "";
        String row2 = "NO,Store No.,Store Name,Area Manager,status,Cashier ID,Cashier Name,Email,Cashier Privilege";
