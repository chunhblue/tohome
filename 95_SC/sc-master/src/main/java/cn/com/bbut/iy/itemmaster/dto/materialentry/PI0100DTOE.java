...
@AllArgsConstructor
@NoArgsConstructor
public class PI0100DTOE extends GridDataDTO {
  ...
  private String expenseAmt;
    ...
    // 明细
    private List<PI0110DTOE> details;

    // 商品明细
    private List<StocktakeItemDTOE> itemList;

    public PI0100DTOE(List rows, long page, long records, long rowPerPage) {
    ...
    public List<PI0110DTOE> getDetails() {
        return details;
    }

    public void setDetails(List<PI0110DTOE> details) {
        this.details = details;
    }

    public List<StocktakeItemDTOE> getItemList() {
        return itemList;
    }

    public void setItemList(List<StocktakeItemDTOE> itemList) {
