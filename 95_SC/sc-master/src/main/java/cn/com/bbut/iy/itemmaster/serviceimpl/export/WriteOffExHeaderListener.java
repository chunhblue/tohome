 ...
 */
@Slf4j
public class WriteOffExHeaderListener implements ExEventListener {

    InventoryVouchersParamDTO param;

    public WriteOffExHeaderListener(InventoryVouchersParamDTO param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Inventory Write-off Query";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Document Date,Document No.,Store Name,Document Type,Status,Remarks," +
