...
/**
 * @ClassName PriceLableExHeaderListener
 * @Description TODO
 * @Author Ldd
...
public class PriceLableExHeaderListener implements ExEventListener {
    PriceLabelParamDTO jsonParam;
    public PriceLableExHeaderListener(PriceLabelParamDTO jsonParam) {
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 ="Price Lable Management";
        // 二号标题
        String row1 = "";
        String row2 = "NO.,Store No.,Store Name,Price Label VN Name,Price Lable EN Name,Top Department,Department,Category,Sub Category,Item Name,Item Barcode,Item Code,Old Price,New Price,Effective Start Date";
