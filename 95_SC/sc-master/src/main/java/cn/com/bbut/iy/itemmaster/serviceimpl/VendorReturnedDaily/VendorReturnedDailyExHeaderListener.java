...
public class VendorReturnedDailyExHeaderListener implements ExEventListener {
    VendorReturnedDailyParamDTO param;

    public VendorReturnedDailyExHeaderListener(VendorReturnedDailyParamDTO param) {
        this.param = param;
    }
    @Override
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Store Returned Daily Report(To Supplier)";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Document No.,Store No.,Store Name,Returned Date,Department,Category,Sub-category,Item Code,Item Name," +
                "Barcode,Vendor Code,Vendor Name,Area Manager Name,Operation Manager Name,Returned Quantity,Created By,Remark";
