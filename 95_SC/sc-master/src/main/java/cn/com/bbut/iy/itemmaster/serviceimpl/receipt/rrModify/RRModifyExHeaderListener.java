 ...
 */
@Slf4j
public class RRModifyExHeaderListener implements ExEventListener {

    RRModifyParamDTO param;

    public RRModifyExHeaderListener(RRModifyParamDTO param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Receiving and Return Document Correction Query";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Modification No.,Modification Date,Vendor Code,Vendor Name,Store No.,Store Name,Area Manager Name,Operation Manager Name,Operation Controller Name," +
