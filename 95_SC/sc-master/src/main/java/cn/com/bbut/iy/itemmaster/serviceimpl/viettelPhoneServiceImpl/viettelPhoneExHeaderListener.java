...
/**
 * @ClassName viettelPhoneExHeaderListener
 * @Description TODO
 * @Author Ldd
 ...
 */
@Slf4j
public class viettelPhoneExHeaderListener implements ExEventListener {

    private  ma8407Paramdto param;

    public viettelPhoneExHeaderListener(ma8407Paramdto param){
        this.param= param;
    }
    @Override
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Viettel Phone Report";
        // 二号标题
        String row1 = "";
        String row2 = "No.,Request Date.,Request ID.,Order ID.,Receipt No.,Trans Amt,Status,Message";
