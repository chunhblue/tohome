...
/**
 * @ClassName rWarehouseBySupplierExHeaderListener
 * @Description TODO
 * @Author Ldd
...
public class rWarehouseBySupplierExHeaderListener  implements ExEventListener {
    RWHListParam param;
    public rWarehouseBySupplierExHeaderListener(RWHListParam param) {
        this.param = param;
    }
    @Override
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Item Return Request List(To Dc)";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Date Returned,Supplier No.,Supplier Name," +
                "Store Code,Store Name,Barcode,Item Code,ItemName,Department";
