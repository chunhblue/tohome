 ...
 */
@Slf4j
public class CashierDetailExHeaderListener implements ExEventListener {

    CashierDetailParam param;

    public CashierDetailExHeaderListener(CashierDetailParam param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        sheet.setZoom(85);
        // 大标题
        String row0 = "Sale Information Report";
