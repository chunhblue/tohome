...
/**
 * Price By Day List Excel标题设置
 *
 */
@Slf4j
public class PriceExHeaderListener implements ExEventListener {

    PriceByDayParamDTO param;

    public PriceExHeaderListener(PriceByDayParamDTO param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Price Info(by Date) Query List";

        // 二号标题
        String row1 = "";

        // 列标题
        /*String row2 = "NO.,Top Department,Department,Category,Sub-Category,Area,Item Code,Item Barcode," +
                "Item Name,Lifecycle Status,Purchasing Price Status,Current Purchasing Price," +
