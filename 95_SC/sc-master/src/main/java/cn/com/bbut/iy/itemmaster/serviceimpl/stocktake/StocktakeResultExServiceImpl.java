 ...
 */
@Slf4j
@Service(value = "stocktakeResultExService")
public class StocktakeResultExServiceImpl implements ExService {
    ...
    public File getExcel(BaseExcelParam param) throws IOException {
        ...
        // 生成文件标题信息对象
        session.setHeaderListener(new StocktakeResultExHeaderListener(jsonParam));
