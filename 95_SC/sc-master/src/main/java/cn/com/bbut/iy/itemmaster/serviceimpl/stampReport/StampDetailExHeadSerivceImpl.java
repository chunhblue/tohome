...
public class StampDetailExHeadSerivceImpl   implements ExEventListener {
    StampSummaryParamReportDto param;

    public StampDetailExHeadSerivceImpl(StampSummaryParamReportDto param){
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Stamp Detail Report At Store Level";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO,Store Code,Store Name,Business Date,Item Code,Item Name,Date Time," +
                "Total Issued Qty,Qty by Bonus Items,Qty by Amount";
