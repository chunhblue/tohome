 ...
 */
@Slf4j
public class DaySaleExHeaderListener implements ExEventListener {

    DaySaleReportParamDTO param;

    public DaySaleExHeaderListener(DaySaleReportParamDTO param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Store Sales Daily Report";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Store No.,Store Name,Date,Customer Count,6h-8h,8h-10h,10h-12h,12h-14h,morning shift," +
                "14h-16h,16h-18h,18h-20h,20h-22h,middle shift,22h-24h,0h-2h,2h-4h,4h-6h,night shift,Total Amt,Area Manager Name";
