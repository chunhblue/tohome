 ...
 */
@Slf4j
public class VendorReceiptDailyExHeaderListener implements ExEventListener {

    VendorReceiptDailyParamDTO param;

    public VendorReceiptDailyExHeaderListener(VendorReceiptDailyParamDTO param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Store Receiving Daily Report(To Supplier)";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Document No.,Store No.,Store Name,Submission Date,Department,Category,Sub-category,Item Code,Item Name," +
                "Barcode,Vendor Code,Vendor Name,Area Manager ID,Operation Manager ID,Receiving Quantity,Created By,Remark";
