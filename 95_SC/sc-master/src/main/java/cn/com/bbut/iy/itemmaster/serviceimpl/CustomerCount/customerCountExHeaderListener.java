...
/**
 * @ClassName customerCountExHeaderListener
 * @Description TODO
 * @Author Ldd
...
public class customerCountExHeaderListener  implements ExEventListener {

    private CustomerCountParamDto paramDto;

    public customerCountExHeaderListener(CustomerCountParamDto paramDto) {
    ...
    public void action(Workbook wb) {
        ...
        // 二号标题
        String row1 = "";
        String row2 = "No.,Store Cd.,Store Name,Date,1K<=Bill<19K,19K<=Bill<29K,29K<=Bill<39K,39K<=Bill<49K,Bill>49K";
