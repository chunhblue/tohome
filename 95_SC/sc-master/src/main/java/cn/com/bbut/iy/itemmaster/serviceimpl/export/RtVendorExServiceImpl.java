 ...
 */
@Slf4j
@Service(value = "rtVendorExService")
public class RtVendorExServiceImpl implements ExService {
    ...
    public File getExcel(BaseExcelParam param) throws IOException {
        ...
        // 生成文件标题信息对象
        session.setHeaderListener(new RtVendorExHeaderListener(jsonParam));
