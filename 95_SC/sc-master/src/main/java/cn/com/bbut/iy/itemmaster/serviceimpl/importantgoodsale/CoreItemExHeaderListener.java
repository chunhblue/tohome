 ...
 */
@Slf4j
public class CoreItemExHeaderListener implements ExEventListener {

    importantgoodSaleReportParamDTO param;

    public CoreItemExHeaderListener(importantgoodSaleReportParamDTO param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Core Item Daily(By Company) Report";
        ...
        String row2 = "No,Store No.,Store Name,Date,Top Department,Department,Category,Sub-Category,Item Code,Item Name,Barcode,Ranking,Sales Quantity," +
                "Selling Price,Sales Date,Area Manager Name";
