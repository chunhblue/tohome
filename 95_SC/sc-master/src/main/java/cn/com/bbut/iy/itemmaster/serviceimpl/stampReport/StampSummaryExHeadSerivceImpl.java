...
public class StampSummaryExHeadSerivceImpl  implements ExEventListener {
    StampSummaryParamReportDto param;

    public StampSummaryExHeadSerivceImpl(StampSummaryParamReportDto param){
        this.param = param;
    }
    @Override
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Stamp Summary Report At Store Level";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO,Business Date,Item Code,Item Name,Total Issued Qty";
