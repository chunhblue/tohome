 ...
 */
@Slf4j
public class ExpenditureExHeaderListener implements ExEventListener {

    ExpenditureParamDTO param;

    public ExpenditureExHeaderListener(ExpenditureParamDTO param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Expenditure List";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Business Date,Expenditure Code,Store No.,Store Name,Department,Expenditure Subject,Expense Type,Expenditure Amount," +
                "Payment Type,Expenditure Description,Expenditure Remarks,Expenditure Status,Operator," +
