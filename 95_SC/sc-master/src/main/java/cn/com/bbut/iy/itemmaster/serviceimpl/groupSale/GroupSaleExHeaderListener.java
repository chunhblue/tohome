 ...
 */
@Slf4j
public class GroupSaleExHeaderListener implements ExEventListener {

    GroupSaleParamDTO param;

    public GroupSaleExHeaderListener(GroupSaleParamDTO param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Group Item Sales Query";
