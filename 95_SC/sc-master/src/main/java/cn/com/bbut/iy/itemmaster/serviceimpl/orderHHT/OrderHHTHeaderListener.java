 ...
 */
@Slf4j
public class OrderHHTHeaderListener implements ExEventListener {
    OrderHHTParamDto param;
    public OrderHHTHeaderListener(OrderHHTParamDto param) {
        this.param = param;
    }
    @Override
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "HHT Order List";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Store No.,Store Name,Order Date,Barcode,Item Code,Item Name,Qty,Vendor Id,Vendor Name,Upload Time";
