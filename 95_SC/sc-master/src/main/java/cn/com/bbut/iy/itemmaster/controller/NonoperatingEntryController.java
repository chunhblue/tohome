...
@Slf4j
//@Secure
@RequestMapping(value = Constants.REQ_HEADER + "/nonoperatingEntry")
public class NonoperatingEntryController extends BaseAction {
    /**
     * 营业外收入登录画面
     *
     * @param request
