...
/**
 * @ClassName CoreItemByExHeaderListener
 * @Description TODO
...
public class CoreItemByExHeaderListener implements ExEventListener {


    coreItemParamDTO param;
    public CoreItemByExHeaderListener( coreItemParamDTO param){
        this.param=param;
    }
    @Override
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Core Item Daily(By Hierarchy) Report";
        // 二号标题
        String row1 = "";
        // 列标题
        String row2 = "No,Store No.,Store Name,Date,Top Department,Department,Category,Sub-Category,Item Code,Item Name,Barcode,Ranking,Sales Quantity," +
                "Sales Amount,Area Manager ID,Area Manager Name";
