 ...
 */
@Slf4j
public class StockAdjustmentExHeaderListener implements ExEventListener {

    InventoryVouchersParamDTO param;

    public StockAdjustmentExHeaderListener(InventoryVouchersParamDTO param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Inventory Adjustment Query";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Document Date,Document No.,Store No.,Store Name,Document Type,Status,Remarks," +
