 ...
 */
@Slf4j
public class WarehouseExHeaderListener implements ExEventListener {

    WarehouseReceiptParamDTO param;

    public WarehouseExHeaderListener(WarehouseReceiptParamDTO param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Item Receiving Query(From DC)";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Document No.,Receiving Store,Submission Date,PO No.,Order Date," +
                "Document Status";
