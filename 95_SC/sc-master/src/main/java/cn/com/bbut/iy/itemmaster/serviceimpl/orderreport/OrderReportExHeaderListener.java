...
/**
 * @ClassName OrderReportExHeaderListener
 * @Description TODO
 ...
 */
@Slf4j
public class OrderReportExHeaderListener implements ExEventListener {
    OrderReportParamDTO param;
    public OrderReportExHeaderListener(OrderReportParamDTO param) {
        this.param = param;
    }
    @Override
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Store Order Daily Report";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Store No.,Store Name,Date,Item Code,Item Name,Item Barcode,UOM,AI SOQ," +
                "Real Ordered,Variance %,Sales PSD";
