 ...
 */
@Slf4j
public class InVoucherExHeaderListener implements ExEventListener {

    InventoryVouchersParamDTO param;

    public InVoucherExHeaderListener(InventoryVouchersParamDTO param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Inventory Document Query List";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO,Document Date,Document No,Store Name,Area Manager Code,Area Manager Name,Operation Manager Code,Operation Manager Name,Operation Controller Code,Operation Controller Name,Document Type,Document Status," +
                "Remarks,Upload,Date Created,Created By";
