 ...
 */
@Slf4j
public class StocktakePlanExHeaderListener implements ExEventListener {

    PI0100ParamDTO param;

    public StocktakePlanExHeaderListener(PI0100ParamDTO param) {
        this.param = param;
    }
    ...
    public void action(Workbook wb) {
        ...
        // 大标题
        String row0 = "Stocktake Plan Query List";

        // 二号标题
        String row1 = "";

        // 列标题
        String row2 = "NO.,Date,Start Time,End Time,Document No.,Store No.,Store Name,Status,Type,Remarks,Day End of Now,Created By,Date Created";
